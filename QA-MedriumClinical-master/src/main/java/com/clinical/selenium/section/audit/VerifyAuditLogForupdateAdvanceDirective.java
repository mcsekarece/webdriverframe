...
public class VerifyAuditLogForupdateAdvanceDirective extends AbstractAuditTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for  Verifying audit logs for update Advance Directive")
	...
	/**
	 * verifyAuditLogsForupdateAdvanceDirective
	 * function to update an existing AdvanceDirective
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
