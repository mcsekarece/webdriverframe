...
public class UpdateRadiologyOrder extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for updating a Radiology Order")
	...
	/**
	 * updateExistingRadiologyOrder
	 * function to update existing Radiology Order
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
