...
public class CreateDuplicateCondition extends AbstractChartsTest {
	...
	/**
	 * createLog
	 * This method is used for creating a log file
	 
	 * @since  	     Jul 20, 2010
	 */


	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for verifying the Alert for Duplicate Allergy")
	...
	/**
	 * createDuplicateCondition
	 * function to create a New Duplicate Condition
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
