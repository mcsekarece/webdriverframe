...
public class UpdateLabRequest extends AbstractChartsTest {
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for updating a labRequest")
	...
	/**
	 * updateExistingLabRequest
	 * function to update existing Lab Request
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
