...
public class VerifyResolvedCondition extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for creating a Resolved Condition")
	...
	/**
	 * verfiyResolvedCondition
	 * function to verify a resolved condition
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
