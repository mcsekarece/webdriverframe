...
public class VerifySaveButtonForAdvanceDirectives extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verifying Save button and Data for Un saved Advance Directive")
	...
	/**
	 * verifySaveButtonForAdvanceDirective
	 * function to Verify Save Button For Advance Directive
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
