...
public class AppointmentsClinical extends AbstractTest {
	...
	/**
	 * appointmentClinical
	 * function for looking for an appointment in Medrium Clinical Site
	 * @param 		seleniumHost
	 * @param 		seleniumPort 
	 * @param 		browser
	 * @param 		webSite
	 ...
	 * @since  	     Mar 23, 2010
	 */
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Clinical Appointments Section")
