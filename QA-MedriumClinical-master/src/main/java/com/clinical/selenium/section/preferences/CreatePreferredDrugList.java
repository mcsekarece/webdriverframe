...
public class CreatePreferredDrugList extends AbstractPreferenceTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for create a preferred drug list")
	 ...
	 * function to Create preferred drug list
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
