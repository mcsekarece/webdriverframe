...
public class CreateNewAllergy extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding New Allergy with End Date")
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding New Allergy without End Date")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
    ...
    @Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding  a Inactive Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
