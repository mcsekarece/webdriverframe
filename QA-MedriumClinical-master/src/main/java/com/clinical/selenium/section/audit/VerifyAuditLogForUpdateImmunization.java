...
public class VerifyAuditLogForUpdateImmunization extends AbstractAuditTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verifying audit logs for Update Immunization")
	...
	/**
	 * verifyAuditLogsForUpdateImmunization
	 * function to Verifying audit logs for Update Immunization
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
