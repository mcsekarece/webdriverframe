...
public class SearchByKeywords extends AbstractChartsTest {
	...
	/**
	 * searchByKeyword
	 * function to perform search operation with a keyword and an input search value in New Clinical Site
	 * @param 		selenium
	 * @param 		keyword
	 * @param 		searchValue
	...
	/**
	 * searchByPatientID
	 * function to search for patient by ID in New Clinical Site
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
	 ...
	 * function to perform search by Appointments in New Clinical Site
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
	...
	/**
	 * searchForAll
	 * function to perform search by All in New Clinical Site
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
