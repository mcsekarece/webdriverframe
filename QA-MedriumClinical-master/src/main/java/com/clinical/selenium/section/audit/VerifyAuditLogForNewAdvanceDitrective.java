...
public class VerifyAuditLogForNewAdvanceDitrective extends AbstractAuditTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verifyning Audit Logs for New Advance Directive")
	...
	/**
	 * VerifyAuditLogForNewAdvanceDirective
	 * function to Verify Audit Logs for New AdvanceDirective
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
