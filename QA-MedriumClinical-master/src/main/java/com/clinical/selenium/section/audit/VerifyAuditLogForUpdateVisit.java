...
public class VerifyAuditLogForUpdateVisit extends AbstractAuditTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for verifying audit logs for update Visit")
	...
	/**
	 * verifyAuditLogForUpdateVisit
	 * function to Verify Audit Log For Update Visit
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
