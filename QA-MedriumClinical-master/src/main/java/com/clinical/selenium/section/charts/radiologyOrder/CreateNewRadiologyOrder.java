...
public class CreateNewRadiologyOrder extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for creating a New Radiology Order")
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for creating a New In Active radiology Order")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
