...
public class UpdateImmunization extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for updating an Immunization")
	...
	/**
	 * updateExistingImmunization
	 * function to update an existing Immunization
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
