...
public class UnitTest_Vitals extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Inches not within the range (>= 12)")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Inches with Special Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Inches with Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Pounds with Numbers")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Pounds with Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Ounces with Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Temperature with Numbers")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Temperature with Special Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Temperature with Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Pulse with Numbers")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Pulse with Special Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Pulse with Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Systolic with Numbers")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Systolic with Special Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Systolic with Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Diastolic with Numbers")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Diastolic with Special Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Diastolic with Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Time with Blank Space")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Time with Alphabets")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Time with Special Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Time with Number")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Metre with Numbers")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Metre with Special Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Metre with Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Centimeters within the range (0 to 99)")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Centimeters not within the range (>= 99)")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Centimeters with Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Kilograms with Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Grams within the range (0 to 999)")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Grams not within the range (>= 999)")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Grams with Special Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Grams with Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Observation Date with a Blank Space")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Observation Date with Numbers")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Observation Date with a Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Observation Date with a Special Characters")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Observation Date with a Future Date")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Kilograms with value > 900")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Pounds with Value > 2000")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Feet with Value > 10")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Height Meter with Value > 3")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Temperature(C) value with > 50")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Temperature(F) value with > 125")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Saving Without selecting any Vital")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	...
	/**
	 * addVitals
	 * function to create a New Vitals
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
