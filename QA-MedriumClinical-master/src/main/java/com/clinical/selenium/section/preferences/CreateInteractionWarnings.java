...
public class CreateInteractionWarnings extends AbstractPreferenceTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for create a New Interaction Warning")
	...
	/**
	 * verifyNewInteractionWarnings
	 * function to verify verify NewInteraction Warnings
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
