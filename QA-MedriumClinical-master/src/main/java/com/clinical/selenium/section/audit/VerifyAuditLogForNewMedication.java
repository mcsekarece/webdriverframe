...
public class VerifyAuditLogForNewMedication extends AbstractAuditTest {

	boolean isValueChecked = false;
	String unMatchedFields = "";

	@Test(groups = {"firefox", "iexplore", "safari", "default"   }, description = "Test for Verifying Audit Logs for New Medication")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	public void verifyAuditLogForNewMedication(String seleniumHost, int seleniumPort,String browser, String webSite){
		...
		verifyAuditLogForNewMedication(seleniumHost, seleniumPort, browser, webSite, medicationTestData);
	}

	/**
	 * verifyAuditLogForNewMedication
	 * function to verify audit Logs for  New Medication
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
	...
	public void verifyAuditLogForNewMedication(String seleniumHost, int seleniumPort,String browser, String webSite, AuditLib medicationTestData){
		...
		try{
			...
			String uniqueID = idOfTheNewlyAddedRecord.split("medication")[1];
			String recordID = "Medication("+uniqueID+")";
			String auditValue[] = searchRecord(selenium, currentDate, currentDate1, "Add", recordID, medicationTestData).split("Set");
			counter1 = 0;
	...
	public void deactiveMedication(Selenium selenium,AuditLib medicationTestData) throws InterruptedException{
