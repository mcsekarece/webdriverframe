...
public class VerifyAuditLogForUpdateLabRequest extends AbstractAuditTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for verifying audit logs for update labRequest")
	...
	/**
	 * verifyAuditLogForUpdateLabRequest
	 * function to verify audit logs for update labRequest
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
