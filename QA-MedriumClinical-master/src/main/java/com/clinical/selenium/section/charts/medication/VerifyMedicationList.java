...
public class VerifyMedicationList extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for display various details in charts section")
	...
	/**
	 * clinicalCharts
	 * function to display various details available in Charts
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
