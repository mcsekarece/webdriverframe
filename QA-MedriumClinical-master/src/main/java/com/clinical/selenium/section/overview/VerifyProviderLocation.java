...
public class VerifyProviderLocation extends AbstractTest {
	 ...
	 * function to add the Provider,Location values in Overview Section and Verify in the charts section
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
	 * @since  	     April 29, 2011
	 */
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Add the Provider,Location values in Overview Section and Verify in the charts section")
