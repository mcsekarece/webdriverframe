...
public class VerifyAuditLogForNewRadiologyOrder extends AbstractAuditTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for verifying audit log for New RadiologyOrder")
	...
	/**
	 * verifyAuditLogsForNewRadiologyOrder
	 * function to  verify audit log for New RadiologyOrder
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
