...
public class EditInteractionWarnings extends AbstractPreferenceTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for edit the interaction Warnings")
	...
	/**
	 * editInteractionWarnings
	 * function to Edit the Interaction Warnings and Verify 
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
	...
	public void editInteractionWarnings(String seleniumHost, int seleniumPort,String browser, String webSite, PreferencesLib interactionTestData){
		...
		try{
			...
			click(selenium, "//table[@id='filterPreferenceTable']/tbody/tr["+counter+"]/td[3]/div/div/a");
			waitForPageLoad(selenium);
