...
public class DeleteInteractionWarnings extends AbstractPreferenceTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for delete interaction warning ")
	...
	/**
	 * deleteInteractionWarnings
	 * function to Delete Interaction Warnings
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
