...
public class VerifyAuditLogForNewAllergy extends AbstractAuditTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verifying audit logs for New Allergy")
	...
	/**
	 * verifyAuditLogForNewAllergy
	 * function to Verify Audit Log for New Allergy
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
