...
public class CreateNewCondition extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for creating a New Condition")
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for creating a In active Condition")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
