...
public class CreateNewAdvanceDirectives extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding New Advance Directive without end date")
	...
	/**
	 * createNewAdvanceDirective
	 * function to create a New AdvanceDirective
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
