...
public class CreateNewLabRequest extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for creating a New labRequest")
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for creating a New In Active labRequest")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
