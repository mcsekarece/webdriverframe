...
public class VerifyAuditLogForNewCondition extends AbstractAuditTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verifying Audit Log for NewCondition")
	...
	/**
	 * verifyAuditLogForNewCondition
	 * function to verify audit logs for New Condition
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
