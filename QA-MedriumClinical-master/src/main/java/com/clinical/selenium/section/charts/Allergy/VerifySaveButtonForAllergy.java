...
public class VerifySaveButtonForAllergy extends AbstractChartsTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verifying Save button and Data for Un saved Allergy")
	...
	/**
	 * verifySaveButtonForUnSavedAllergy
	 * function to verify Save Button For UnSaved Allergy
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
