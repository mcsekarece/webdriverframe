...
public class CreateDuplicateMedication extends AbstractChartsTest {
	...
	/**
	 * BeforeTest
	 * This method is used for creating a directory for storing log files
	 
	 * @since  	     Jul 20, 2010
	 */

	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for verifying the alert for duplicate medication")
	...
	/**
	 * createDuplicateMedication
	 * function to create Duplicate Medication
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
