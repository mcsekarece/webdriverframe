...
public class DeletePreferredDrugList extends AbstractPreferenceTest {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verifying audit logs for Delete preferred drug list")
	...
	/**
	 *  verifyDeletePreferredDrugList
	 * This method is used for deleting a preferred list
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
