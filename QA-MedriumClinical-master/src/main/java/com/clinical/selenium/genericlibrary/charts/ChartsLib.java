...
/**
 *  ChartsLib
 * This Class will contain reusable functions which can be used in New Clinical Interface
 * @Category 	Charts
 * @since  	    Apr 04, 2010
 */
public class ChartsLib {
	...
	public String expectedAlertText = null;
	public String pharmacyName = null;
    public String description = null;
	public String brandName = null;
	public String genericName = null;

	public String brandName1 = null;
	public String genericName1 = null;

	public String brandName2 = null;
	public String genericName2 = null;



	public String workBookName = "TestData_NewClinicalInterface.xls";		
	 ...
	 * @since  	     Apr 04, 2010	  
	 */
	public boolean fetchChartsTestData(){
					...
					for(int c = 0; c < excelrRowColumnCount.get("ColumnCount"); c++) {						
						...
						if(cell != null){
							...
							if(temptestCaseId.equals(testCaseId)){							
								...
								}else if(workSheetName.equalsIgnoreCase("VerifyPrescription(E-Rx)" )){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
								...
								if(workSheetName.equalsIgnoreCase("VerifyMultiplePrescription" )){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									...
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
									taskNotes= readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("TaskNotes")));
								}if(workSheetName.equalsIgnoreCase("VerifySaveButtonForPrescription" )){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									...
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
									taskNotes= readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("TaskNotes")));
								}else if(workSheetName.equalsIgnoreCase("VerifySaveButtonForCondition" )){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									...
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
									taskNotes= readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("TaskNotes")));
								}else if(workSheetName.equalsIgnoreCase("CreateDuplicateCondition" )){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									...
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
									taskNotes= readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("TaskNotes")));
									expectedAlertText = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("ExpectedAlert")));
									...
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
									taskNotes= readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("TaskNotes")));
								}else if (workSheetName.equalsIgnoreCase("VerifySaveButtonForDirective")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									...
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
									taskNotes= readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("TaskNotes"))); 
								}else if(workSheetName.equalsIgnoreCase("VerifySaveButtonForAllergy")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									...
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
									taskNotes= readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("TaskNotes"))); 
								}else if(workSheetName.equalsIgnoreCase("CreateDuplicateAllergy")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
								...
								}else if(workSheetName.equalsIgnoreCase("VerifySaveButtonForImmunization")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
								...
								}else if(workSheetName.equalsIgnoreCase("VerifySaveButtonSocialHistory")){
									testDescription = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("TestDescription")));
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									...
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
									taskNotes= readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("TaskNotes")));
								}else if(workSheetName.equalsIgnoreCase("VerifySaveButtonForVisit")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									...
									taskName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Task")));
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
								}if(workSheetName.equalsIgnoreCase("VerifyDrugInteractionMedication")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
								...
								}else if(workSheetName.equalsIgnoreCase("CreateDuplicateMedication")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									...
									taskName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Task")));
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
								}else if(workSheetName.equalsIgnoreCase("VerifySaveButtonForMedication")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									...
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
									taskNotes= readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("TaskNotes")));
								}else if(workSheetName.equalsIgnoreCase("VerifySaveButtonForReferral")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
								...
								}else if(workSheetName.equalsIgnoreCase("VerifySaveButtonForLabRequest")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
								...
								}else if(workSheetName.equalsIgnoreCase("VerifySaveButtonForVitals")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
								...
								}else if(workSheetName.equalsIgnoreCase("VerifySaveButtonRadiologyOrder")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									...
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));									
								}if(workSheetName.equalsIgnoreCase("VerifyPrescriptionStatusIcons" )){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									...
									taskName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Task")));
									sendTaskTo = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SendTaskTo")));
								}if(workSheetName.equalsIgnoreCase("VerifyMedicationList" )){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
									medicationName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("MedicationName")));
									brandName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("BrandName")));
									genericName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("GenericName")));
									medicationName1 = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("MedicationName1")));
									brandName1 = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("BrandName1")));
									genericName1 = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("GenericName1")));
									medicationName2 = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("MedicationName2")));
									brandName2 = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("BrandName2")));
									genericName2 = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("GenericName2")));									

								}else if(workSheetName.equalsIgnoreCase("VerifyVisitSubjectiveCondition")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									patientID = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientID")));
