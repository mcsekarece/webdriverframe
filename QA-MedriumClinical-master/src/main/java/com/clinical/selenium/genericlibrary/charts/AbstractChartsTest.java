...
public class AbstractChartsTest extends AbstractTest {

	public void createAdvanceDirective(Selenium selenium, ChartsLib directiveTestData){
		String allDirectiveCount = null;
		String activeDirectiveCount = null;
		try {
			Assert.assertTrue(click(selenium,"advDirectives"),"Could Not Click the Advance Directive Link; More Details" + directiveTestData.toString());
			waitForPageLoad(selenium);

			Assert.assertTrue(click(selenium,"AllDirectives"),"Could Not Click the All Advance Directive Link; More Details" + directiveTestData.toString());
			waitForPageLoad(selenium);
			...
			Assert.assertFalse(selenium.isElementPresent("//div[@class='dialogMiddleCenterInner dialogContent']/div/div[2]/ol/li/div") ,"UnExpected Alert is Displaed  :- "+ getMessage(selenium, "//div[@class='dialogMiddleCenterInner dialogContent']/div/div[2]/ol/li/div").trim());
			...
			Assert.assertTrue(waitForValue(selenium, "CurrentDirectives", 120000),"Could not capture Advance Directives[Active] Count after saving a Advance Directives; More Details" + directiveTestData.toString());
			...
			if(directiveTestData.directiveEndDate.equals("") ){
				...
				Assert.assertTrue(Integer.parseInt(getListCount(selenium.getText("CurrentDirectives"))) == Integer.parseInt(activeDirectiveCount),"The Advance Directive[Active] is not Saved Successfully, Advance Directives count has no change after adding a new Advance Directive; More Details" + directiveTestData.toString());
			}
	...
	public void createMedication(Selenium selenium, ChartsLib medicationTestData){
	...
	public void createPrescription(Selenium selenium, ChartsLib prescriptionTestData ){
	...
	public void createReferral(Selenium selenium, ChartsLib referralTestData  ){
	...
	public void createVisit (Selenium selenium, ChartsLib visitTestData  ){
	...
	public void createVitals (Selenium selenium, ChartsLib vitalsTestData  ){
	...
	public void createLabRequest (Selenium selenium, ChartsLib labRequestTestData  ){
	...
	public void createImmunization (Selenium selenium, ChartsLib immunizationTestData  ){
	...
	public void createAllergy(Selenium selenium, ChartsLib allergyTestData){		
		...
		try {
			//--------------------------------------------------------------------//
			//  Step-2:  Click Add New Allergy and enter details                  //
			//--------------------------------------------------------------------//
			...
			Assert.assertTrue((waitForValue(selenium, "AllAllergies", 120000)),"Could not capture Allergy[All] Count after saving a Allergy; More Details" + allergyTestData.toString());
			Assert.assertTrue(Integer.parseInt(getListCount(selenium.getText("AllAllergies"))) == Integer.parseInt(allAllergyCount)+1,"Could not capture Allergy[Active] Count after saving a Allergy; More Details" + allergyTestData.toString());

			Assert.assertTrue(waitForValue(selenium, "CurrentAllergies", 120000),"The Allergy is not Saved Successfully, Allergy[Active] count has no change after adding a new Allergy; More Details" + allergyTestData.toString());
			if (!allergyTestData.status.trim().equalsIgnoreCase("inactive")){
				...
				Assert.assertTrue(Integer.parseInt(getListCount(selenium.getText("CurrentAllergies"))) == Integer.parseInt(activeAllergyCount),"The Allergy is not Saved Successfully, Allergy[Active] count has no change after adding a new Allergy; More Details" + allergyTestData.toString());
			}
	...
	public void createCondition(Selenium selenium, ChartsLib conditionTestData){		
		...
		if(!conditionTestData.status.trim().equalsIgnoreCase("inactive")){
			Assert.assertTrue(Integer.parseInt(getListCount(selenium.getText("CurrentConditions"))) == Integer.parseInt(activeConditionsCount)+1,"The condition is not Saved Successfully, Active condition count has no change after adding a new condition; More Details" + conditionTestData.toString());
		}else{
			Assert.assertTrue(Integer.parseInt(getListCount(selenium.getText("CurrentConditions"))) == Integer.parseInt(activeConditionsCount),"The condition is not Saved Successfully, Active condition count has no change after adding a new condition; More Details" + conditionTestData.toString());
		}
	...
	public void createRadiologyOrder (Selenium selenium, ChartsLib radiologyOrderTestData ){

		String allRadiologyOrderCount = null;
		String currentRadiologyCount = null;
		...
		currentRadiologyCount = getListCount(selenium.getText("CurrentRadiologyOrders"));
		...
		{
			Assert.assertTrue(Integer.parseInt(getListCount(selenium.getText("CurrentRadiologyOrders")))== Integer.parseInt(currentRadiologyCount),"The Radiology Order is not Saved Successfully, Radiology Order count has no change after adding a new Radiology Order; More Details" + radiologyOrderTestData.toString());
		}
		else
		{
			Assert.assertTrue(Integer.parseInt(getListCount(selenium.getText("CurrentRadiologyOrders")))== Integer.parseInt(currentRadiologyCount)+1,"The Radiology Order is not Saved Successfully, Radiology Order count has no change after adding a new Radiology Order; More Details" + radiologyOrderTestData.toString());
		}
