...
public class ChartPreVisitLib {
	...
	public String fileToSection=null;
...
public String accessLevel=null;
	...
	//Export Chart
		public String providerNameEC=null;
		public String passwordEC=null;
		public String RenderingProviderName=null;
					...
					for(int c = 0; c < excelrRowColumnCount.get("ColumnCount"); ) {						
						...
						if(cell != null){
							...
							if(temptestCaseId.equals(testCaseId)){
								isDataFound = true;	
								if(workSheetName.equalsIgnoreCase("OrderTemplate")){
								...
								else if(workSheetName.equalsIgnoreCase("PrescribeMedi")){
									userAccount = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("AccountNumber")));
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									switchRole = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SwitchRole")));
									...
									patientId = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientId")));
									switchRole=readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SwitchRole")));
									providerNameEC = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("ProviderName")));
									break;
								}
									...
									RenderingProviderName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("RenderingProvider")));
									testName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("TestName")));
									break;
								}
									...
									fileToSection =readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("FileToSection")));	
									break;
								}
								else if(workSheetName.equalsIgnoreCase("OrderNotifyMe")){ 
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									switchRole = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SwitchRole")));
									patientId = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientId")));
									...
									break;	
								}else if(workSheetName.equalsIgnoreCase("ExportChart")){
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									switchRole = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SwitchRole")));
									providerNameEC = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("ProviderName")));
									passwordEC = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Provider Password")));
									patientId = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("PatientId")));
									break;
								}else if(workSheetName.equalsIgnoreCase("ImportChart")){
									userName = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("UserName")));
									userPassword = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("Password")));
									switchRole = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SwitchRole")));
									providerNameEC = readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("ProviderName")));
