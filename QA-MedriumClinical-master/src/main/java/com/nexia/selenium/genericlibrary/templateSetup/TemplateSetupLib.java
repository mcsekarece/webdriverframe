...
public class TemplateSetupLib {
	...
	public String sortDataBy = null;
	public String timeAndDateID = null;
	
	public String workSheetName = null;
	public String workBookName = "TestData_TemplateSetup.xls";		
					...
					for(int c = 0; c < excelrRowColumnCount.get("ColumnCount"); c++) {						
						...
						if(cell != null){
							...
							if(temptestCaseId.equals(testCaseId)){
								isDataFound = true;
								if(workSheetName.equalsIgnoreCase("CreateTemplateSetup")){
                                    ...
                                    sortDataBy=readTestData.convertHSSFCellToString(row.getCell(excelHeaders.get("SortBy")));
