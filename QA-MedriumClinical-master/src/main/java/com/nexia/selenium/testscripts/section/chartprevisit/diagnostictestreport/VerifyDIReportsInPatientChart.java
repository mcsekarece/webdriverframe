...
public class VerifyDIReportsInPatientChart extends AbstractChartPreVisit{

	@Test(groups = {"SingleThread","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verify DIReports In Patient Chart")
	...
	/** 
	 * Verify DIReports In Patient Chart
	 * function to Verify DIReports In Patient Chart
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
	...
	try{
			...
			assertTrue(verifyReportDetails(selenium,diData,userAccount),"Verify Report Details in DI chart failed", selenium, ClassName,MethodName);
			waitForPageLoad(selenium);
...
public boolean verifyReportDetails(Selenium selenium, ChartPreVisitLib diData, String userAccount) throws IOException{
