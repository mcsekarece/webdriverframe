...
public class AddLocationInAdminPractice extends AbstractSystemSettingsTest{
	@Test(groups = {"AdvancedSmoke","Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding a Location With Practice")
	...
	/*************************************************************************************************** 
	* @purpose        verify Add Location
	* @action 		  verifying Add Location
	* @author         Aspire QA
	* @throws         IOException 
	* @state          Developing
