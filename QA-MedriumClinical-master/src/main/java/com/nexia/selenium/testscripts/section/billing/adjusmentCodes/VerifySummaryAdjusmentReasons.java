...
public class VerifySummaryAdjusmentReasons extends AbstractBilling {
	...
	public void verifySummaryAdjusmentReasons(String seleniumHost, int seleniumPort,
		...
		adjustmentCodeData.testCaseId = "TC_AC_018";
	...
	public boolean verifySummaryAdjusmentReasons(String seleniumHost, int seleniumPort,
		...
		try {
			...
			assertTrue(	searchAdjustmentReasons(selenium,adjustmentCodeData),"selection failed", selenium, ClassName,
					MethodName);
			assertTrue(
