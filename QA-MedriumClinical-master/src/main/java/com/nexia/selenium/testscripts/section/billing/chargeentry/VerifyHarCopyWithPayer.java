...
public class VerifyHarCopyWithPayer extends AbstractSystemSettingsTest {
    	@Test(groups = {"AdvancedSmokeUS","RegressionUS","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for verify hard copy check box")
