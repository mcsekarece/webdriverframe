...
public class VerifyAuditLogForCreateDirectories extends AbstractAuditLog{
	...
	public void createNewDirectories(String seleniumHost, int seleniumPort,String browser, String webSite,String userAccount) throws Exception {
		...
		createDirectories(seleniumHost, seleniumPort, browser, webSite, directoriesData, userAccount);
	}
	...
	public boolean createDirectories(String seleniumHost, int seleniumPort,String browser, String webSite, AuditLogLib directoriesData,String userAccount) throws IOException{
