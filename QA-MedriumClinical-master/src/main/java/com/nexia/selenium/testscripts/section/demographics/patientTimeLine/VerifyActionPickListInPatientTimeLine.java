...
public class VerifyActionPickListInPatientTimeLine extends AbstractSchedulingTest{
	@Test(groups = {"AdvancedSmoke","Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test For Verifying Resource Details in Patient Time Line ")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void ActionPickListInPatientTimeLine(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount)throws Exception{
	    ...
	    verifyActionPickList(seleniumHost, seleniumPort, browser, webSite, userAccount, patientTimeLineData);
	} 
	
	/*************************************************************************************************** 
	* @purpose        To verify Action Pick List
	* @action 		  verify Action Pick List
	* @expected       To Ensure that the verify Action Pick List works fine    
	* @author         Aspire Qa
	* @state          Developing
	...
	***************************************************************************************************/
	...
	public boolean verifyActionPickList(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, SchedulingTestLib patientTimeLineData) throws Exception{
		...
		try{
			...
			assertTrue(selenium.isTextPresent("Confirm Visit"),"Confirm Visit text is not present",selenium, ClassName, MethodName);
			assertTrue(selenium.isTextPresent("Reschedule Visit"),"Reschedule Visit text is not present",selenium, ClassName, MethodName);
			assertTrue(selenium.isTextPresent("Cancel Visit"),"Cancel Visit text is not present",selenium, ClassName, MethodName);
			assertTrue(selenium.isTextPresent("Edit Visit"),"Edit Visit text is not present",selenium, ClassName, MethodName);
