...
public class RemoveAssociatePayersInProvider extends AbstractSystemSettingsTest{
	...
	public void removeAssociatePayer(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		removePayer(seleniumHost, seleniumPort, browser, webSite, userAccount, providerData);
	}
	/**
	 * removePayer
	 ...
	 * @since  	    Feb 20, 2010
	 */
	public boolean removePayer(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, SystemSettingsLib providerData) throws Exception{
		...
		try{
			...
			//  Step-9: Remove Payer //
			//--------------------------------------------------------------------//
			assertTrue(click(selenium,btnAssociatePayerRemove),"Could not click the Remove button", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
			waitForPageLoad(selenium);
			assertTrue(click(selenium,btnYes),"Could not click Yes button", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
			
			assertTrue(!selenium.isTextPresent(payerData.payerName),"Payer is not removed ", selenium, ClassName, MethodName);
