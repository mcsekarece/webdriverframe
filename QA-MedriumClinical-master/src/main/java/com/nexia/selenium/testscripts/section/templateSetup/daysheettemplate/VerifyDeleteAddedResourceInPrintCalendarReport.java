...
public class VerifyDeleteAddedResourceInPrintCalendarReport extends AbstractTemplateSetup {
	@Test(groups = {"SingleThread","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verify delete added resource in print calendar report")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyDeleteAddedResourceInPrintCalendarReport(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
	...
	/*************************************************************************************************** 
	* @purpose        verify delete added resource in print calendar report
	* @action 		  verifying delete added resource in print calendar report
	* @author         Aspire QA
	* @throws         IOException 
	...
	***************************************************************************************************/
	...
	public boolean daySheetTemplate(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, TemplateSetupLib daySheetTemplateTestData ) throws IOException, AWTException, InterruptedException{
		...
		try{
			...
			//--------------------------------------------------------------------//
			//  Step-8: Verify delete added resource in print calendar report	  //
			//--------------------------------------------------------------------//
			assertTrue(verifyDeleteAddedResourceInPrintCalendarReport(selenium, daySheetTemplateTestData,userAccount), "Could not verify delete added resource in print calendar report", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
