...
public class VerifyCreateEncounterImmunizationInSummary extends AbstractChartPreVisit{
	
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Create Encounter Immunization")
	...
	public void createImmunization(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		immunizationData.testCaseId = "TC_CIM_039";
