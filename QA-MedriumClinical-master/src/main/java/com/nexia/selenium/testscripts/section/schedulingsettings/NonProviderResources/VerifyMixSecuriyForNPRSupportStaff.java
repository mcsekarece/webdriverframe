...
public class VerifyMixSecuriyForNPRSupportStaff extends AbstractSchedulingTest {
	...
	public boolean verifySecurity(Selenium selenium,SchedulingTestLib nonProviderSS,SystemSettingsLib userRoleData, String userAccount) throws IOException{
		boolean returnValue=true;
