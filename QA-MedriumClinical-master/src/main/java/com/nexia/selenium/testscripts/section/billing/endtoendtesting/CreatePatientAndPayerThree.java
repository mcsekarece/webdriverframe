...
public class CreatePatientAndPayerThree extends AbstractHomeTest{
	public String workBookName = "TestData_Home.xls";		
	public String sectionName = "home";

	@Test(groups = {"EndToEnd","Developing","firefox", "iexplore", "safari", "default" ,"BeforeCreatePatientAndPayerThird"}, description = "Test for Adding a New patient and Medical Payer")
	...
	***************************************************************************************************/
	public boolean createNewPatientWithMandatoryFields (String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, HomeLib patientData) throws Exception{
		...
		try{
			...
			patient1Data.testCaseId = "TC_NPC_022";
			patient1Data.fetchHomeTestData();
			
			createNewPatient(selenium,patient1Data);		
			waitForPageLoad(selenium);
			if(patient1Data.testCaseId.equals("TC_NPC_022")){
				...
				payerData5.testCaseId = "TC_CP_032";
				rowPossition = 32;
