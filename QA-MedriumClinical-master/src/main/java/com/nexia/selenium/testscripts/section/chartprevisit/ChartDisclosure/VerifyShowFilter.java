...
public class VerifyShowFilter extends AbstractChartPreVisit{
	...
	public void verifyAllActivities(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib allergyData = new ChartPreVisitLib();
		allergyData.workSheetName = "CreatePatientTask";
		allergyData.testCaseId = "TC_CD_022";
		allergyData.fetchChartPreVisitTestData();
		verifyShowFilter(seleniumHost, seleniumPort, browser, webSite, userAccount, allergyData);
	}
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyEncounters(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib allergyData = new ChartPreVisitLib();
		allergyData.workSheetName = "CreatePatientTask";
		allergyData.testCaseId = "TC_CD_023";
		allergyData.fetchChartPreVisitTestData();	
		verifyShowFilter(seleniumHost, seleniumPort, browser, webSite, userAccount, allergyData);
	}
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyPrescription(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib allergyData = new ChartPreVisitLib();
		allergyData.workSheetName = "CreatePatientTask";
		allergyData.testCaseId = "TC_CD_024";
		allergyData.fetchChartPreVisitTestData();
		verifyShowFilter(seleniumHost, seleniumPort, browser, webSite, userAccount, allergyData);
	}
	...
	public void verifyLabReport(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		ChartPreVisitLib allergyData = new ChartPreVisitLib();
		allergyData.workSheetName = "CreatePatientTask";
		allergyData.testCaseId = "TC_CD_025";
		allergyData.fetchChartPreVisitTestData();
		verifyShowFilter(seleniumHost, seleniumPort, browser, webSite, userAccount, allergyData);
	}
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyPatientSummary(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib allergyData = new ChartPreVisitLib();
		allergyData.workSheetName = "CreatePatientTask";
		allergyData.testCaseId = "TC_CD_036";
		allergyData.fetchChartPreVisitTestData();
		verifyShowFilter(seleniumHost, seleniumPort, browser, webSite, userAccount, allergyData);
	}
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyAssesmentLink(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib allergyData = new ChartPreVisitLib();
		allergyData.workSheetName = "CreatePatientTask";
		allergyData.testCaseId = "TC_CD_037";
		allergyData.fetchChartPreVisitTestData();
		verifyShowFilter(seleniumHost, seleniumPort, browser, webSite, userAccount, allergyData);
	}
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyPayersLink(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib allergyData = new ChartPreVisitLib();
		allergyData.workSheetName = "CreatePatientTask";
		allergyData.testCaseId = "TC_CD_038";
		allergyData.fetchChartPreVisitTestData();
		verifyShowFilter(seleniumHost, seleniumPort, browser, webSite, userAccount, allergyData);
	}
	...
	public boolean verifyShowFilter(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount,ChartPreVisitLib chartDisclosureData) throws IOException{
		...
		try{
			...
			if (chartDisclosureData.testCaseId.equals("TC_CD_022")) {
				Integer cntAllActivities = (Integer) selenium.getXpathCount(lblContentPanel);
				assertTrue(cntAllActivities==3,"All Activities not Visible Correctly", selenium , ClassName, MethodName);
			}
			if (chartDisclosureData.testCaseId.equals("TC_CE_023")) {
				assertTrue(selectValueFromAjaxList(selenium,lstShowSuggestBox,"Prescriptions"),"Default Show is not All Activities", selenium , ClassName, MethodName);
				Integer cntAllActivities = (Integer) selenium.getXpathCount(lblContentPanel);
				assertTrue(cntAllActivities==1,"All Activities not Visible Correctly", selenium , ClassName, MethodName);
			}
			if (chartDisclosureData.testCaseId.equals("TC_CD_024")) {
				assertTrue(selectValueFromAjaxList(selenium,lstShowSuggestBox,"Encounters"),"Default Show is not All Activities", selenium , ClassName, MethodName);
				Integer cntAllActivities = (Integer) selenium.getXpathCount(lblContentPanel);
				assertTrue(cntAllActivities==3,"All Activities not Visible Correctly", selenium , ClassName, MethodName);
			}
			if (chartDisclosureData.testCaseId.equals("TC_CE_025")) {
				assertTrue(selectValueFromAjaxList(selenium,lstShowSuggestBox,"Lab Reports"),"Default Show is not All Activities", selenium , ClassName, MethodName);
				Integer cntAllActivities = (Integer) selenium.getXpathCount(lblContentPanel);
				assertTrue(cntAllActivities==1,"All Activities not Visible Correctly", selenium , ClassName, MethodName);
			}
			if (chartDisclosureData.testCaseId.equals("TC_CE_036")) {
				assertTrue(selectValueFromAjaxList(selenium,lstShowSuggestBox,"Lab Reports"),"Default Show is not All Activities", selenium , ClassName, MethodName);
				Integer cntAllActivities = (Integer) selenium.getXpathCount(lblContentPanel);
				assertTrue(cntAllActivities==4,"All Activities not Visible Correctly", selenium , ClassName, MethodName);
			}
			if (chartDisclosureData.testCaseId.equals("TC_CD_037")) {
				assertTrue(selectValueFromAjaxList(selenium,lstShowSuggestBox,"All Activities"),"Default Show is not All Activities", selenium , ClassName, MethodName);
				assertTrue(selectValueFromAjaxList(selenium,ajxAddFilterBy,"Assessments"),"Default Show is not All Activities", selenium , ClassName, MethodName);
				assertTrue(isElementPresent(selenium, lnkSelectAssesment),"Select Assesment link not present", selenium , ClassName, MethodName);
			}
			if (chartDisclosureData.testCaseId.equals("TC_CD_038")) {
				assertTrue(selectValueFromAjaxList(selenium,lstShowSuggestBox,"All Activities"),"Default Show is not All Activities", selenium , ClassName, MethodName);
				assertTrue(selectValueFromAjaxList(selenium,ajxAddFilterBy,"Payers"),"Default Show is not All Activities", selenium , ClassName, MethodName);
				assertTrue(isElementPresent(selenium, lnkSelectPayers),"Select Payers link not present", selenium , ClassName, MethodName);
			}
