...
public class VerifyAuditLogForEditFamilyHistory extends AbstractAuditLog{
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	public void editFamilyHistoryWithFullDetails(String seleniumHost, int seleniumPort,String browser,String userAccount, String webSite) throws Exception {
	...
	public boolean editFamilyHistory(String seleniumHost, int seleniumPort,String browser, String webSite,String userAccount, AuditLogLib historyData){
		...
		try{
			...
			Assert.assertTrue(loginForNexiaFromProviderSite(selenium, historyData.userAccount, historyData.userName, historyData.userPassword),"Login Failed ");
			...
			historyData.workSheetName = "AuditLogForFamilyHistory";
			historyData.testCaseId = "TC_AFH_002";
			historyData.fetchHomeTestData();
			
			Assert.assertTrue(click(selenium,"//div[@id='FamilyHistoryList']/table/tbody/tr/td[3]/div/a"),"Could not click the edit button;More Details:"+historyData.toString());
			waitForPageLoad(selenium);
