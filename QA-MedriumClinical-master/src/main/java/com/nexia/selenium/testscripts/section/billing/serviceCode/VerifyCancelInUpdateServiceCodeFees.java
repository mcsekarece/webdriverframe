...
public class VerifyCancelInUpdateServiceCodeFees extends AbstractBilling {
    	
    @Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Verify cancel in update service code fees")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyCancelInUpdateServiceCodeFees(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
    ...
    /*************************************************************************************************** 
	* @purpose        Verify cancel functionality in update service code fees
	* @action 		  verifying cancel functionality in update service code fees
	* @author         Aspire QA
	* @throws         IOException 
	* @state          Developing
	...
	public boolean verifyCancelInUpdateServiceCodeFees(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, BillingLib billingData) throws IOException{
		...
		try{
			...
			if(!isElementPresent(selenium, btnManageServiceCodes)){
				Assert.fail("Cancel functionality not working in the edit service code");
			}
