...
public class VerifyActionOption extends AbstractTaskManagement{
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verifying Action Option ")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void actionOptionInTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		verifyActionOption(seleniumHost, seleniumPort, browser, webSite, userAccount,createPatientTask);
	}
	
	/*************************************************************************************************** 
	* @purpose        verify Action Option
	* @action 		  verifying Action Option
	* @author         Aspire QA
	* @throws         IOException 
	* @state          Developing
	...
	***************************************************************************************************/
	...
	public boolean verifyActionOption(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, TaskManagementLib createPatientTask ) throws IOException{
		...
		try{
			...
			assertTrue(selenium.isTextPresent("Cannot Complete"),"Cannot Complete  is not getting displayed",selenium, ClassName, MethodName);
			assertTrue(selenium.isTextPresent("Reassign"),"Reassign is not getting displayed",selenium, ClassName, MethodName);
			assertTrue(selenium.isTextPresent("Put on hold"),"Put on hold is not getting displayed",selenium, ClassName, MethodName);
			assertTrue(selenium.isTextPresent("Notify assigner"),"Notify assigner is not getting displayed",selenium, ClassName, MethodName);
