...
public class VerifySecurityOptionForIdentiFierTypes extends AbstractSystemSettingsTest {
	...
	public boolean verifySecurityOption(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, SystemSettingsLib idGroupData) throws IOException{
		...
		try{
			...
			//--------------------------------------------------------------------//
			//  Step-5: Create Identifier Group//
			//--------------------------------------------------------------------//
			if(idGroupData.testCaseId.equals("TC_VSP_001")||idGroupData.testCaseId.equals("TC_VSP_004")){
				SystemSettingsLib idGroupData1 = new SystemSettingsLib();
				idGroupData1.workSheetName = "CreateIdentifierGroups";
				idGroupData1.testCaseId = "TC_IDG_001";
				idGroupData1.fetchSystemSettingTestData();
				...
				waitForPageLoad(selenium);
				assertTrue(createIdGroup(selenium,idGroupData1),"Identifier Groups Creation failed", selenium, ClassName, MethodName);
				waitForPageLoad(selenium);
			}
