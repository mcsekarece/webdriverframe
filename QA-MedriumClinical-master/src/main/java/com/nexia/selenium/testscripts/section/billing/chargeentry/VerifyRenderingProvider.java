...
public class VerifyRenderingProvider extends AbstractBilling {

	@Test(groups = {"RegressionCA", "Approved", "firefox", "iexplore", "safari",	"default" }, description = "Test for Verify AuditLog For Add Payer")
	@Parameters({ "seleniumHost", "seleniumPort", "browser", "webSite",
			"userAccount" })
	public void verifyRenderingProvider(String seleniumHost, int seleniumPort,
		...
		chargeEntryData.testCaseId = "TC_CE_058";
