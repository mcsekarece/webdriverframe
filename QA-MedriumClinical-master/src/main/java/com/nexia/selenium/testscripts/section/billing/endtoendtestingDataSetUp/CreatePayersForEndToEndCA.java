...
public class CreatePayersForEndToEndCA extends AbstractSystemSettingsTest {	
	
	
	@Test(groups = {"EndToEndCA","Developing","firefox", "iexplore", "safari", "default" }, description = "Test for Creating Payers For Portability")
	...
	***************************************************************************************************/
	...
	public boolean searchPayers(Selenium selenium, SystemSettingsLib createPayer) throws IOException{
	    ...
	    if(getText(selenium,listPayer).contains(createPayer.payerName)){
	    	return false;
	    }
