...
public class ValidateMammogramRecallListExclusion extends AbstractChartPreVisit {	
	...
	public boolean patientNameRemovalFromRecallList(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ChartPreVisitLib careData ) throws IOException{
		...
		try{
			...
			//--------------------------------------------------------------------//
			assertTrue(setNeverRecallAlertForPatient(selenium,userAccount,careData), "Could not set Force Recall for patient", selenium, ClassName, MethodName);
	...
	private boolean setNeverRecallAlertForPatient(Selenium selenium, String userAccount, ChartPreVisitLib careData) throws IOException {
