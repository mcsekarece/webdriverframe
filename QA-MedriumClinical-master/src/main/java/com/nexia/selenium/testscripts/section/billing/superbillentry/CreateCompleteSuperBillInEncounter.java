...
public class CreateCompleteSuperBillInEncounter extends AbstractBilling{
	@Test(groups = {"AdvancedSmoke","Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verify Super Bill Entry Count")
	...
	public void createSuperBillInEncounter(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		superBillData.testCaseId = "TC_SBE_002";
