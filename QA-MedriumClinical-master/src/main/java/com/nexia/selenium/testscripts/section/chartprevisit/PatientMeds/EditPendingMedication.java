...
public class EditPendingMedication extends AbstractChartPreVisit{
	@Test(groups = {"Regression","Approved", "iexplore", "safari", "default" }, description = "Test for restart a medication")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void editPendingMedication(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ChartPreVisitLib prescribeData = new ChartPreVisitLib();
		prescribeData.workSheetName = "PrescribeMedi";
		prescribeData.testCaseId = "TC_PM_089";
	...
	public boolean editPendingMedication(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ChartPreVisitLib prescribeData) throws Exception{
		...
		try{
			...
			assertTrue(click(selenium,lnkOption), "Could not click on option button", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
			waitForPageLoad(selenium);
			assertTrue(isElementPresent(selenium,lnkCurrentEdit),"Could not find the edit button", selenium, ClassName, MethodName);
			
			selenium.click(lnkCurrentEdit);
			//assertTrue(click(selenium,lnkCurrentEdit), "Could not click on Edit button");
			waitForPageLoad(selenium);
