...
public class VerifySelectAllResourceInPrintCalendarReport extends AbstractTemplateSetup {
	@Test(groups = {"SingleThread","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verify select all resource in print calendar report")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifySelectAllResourceInPrintCalendarReport(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
	...
	/*************************************************************************************************** 
	* @purpose        verify select all resource in print calendar report 
	* @action 		  verifying select all resource in print calendar report
	* @author         Aspire QA
	* @throws         IOException 
	...
	***************************************************************************************************/
	...
	public boolean daySheetTemplate(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, TemplateSetupLib daySheetTemplateTestData ) throws IOException, AWTException, InterruptedException{
		...
		try{
			...
			//--------------------------------------------------------------------//
			//  Step-8: Verify select all in print calendar report				  //
			//--------------------------------------------------------------------//
			assertTrue(verifySelectAllInPrintCalendarReport(selenium, daySheetTemplateTestData,userAccount), "Could not verify select all in print calendar report", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
