...
public class ScenarioTwo extends AbstractBilling{
	@MapToTestLink(testCaseID = "Post Payer Payments- MP1")
	...
	public void scenarioTwo(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
