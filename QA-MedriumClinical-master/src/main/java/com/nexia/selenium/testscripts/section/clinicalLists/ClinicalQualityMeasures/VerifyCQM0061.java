...
public class VerifyCQM0061 extends AbstractClinicalList{
	...
	***************************************************************************************************/
	public boolean verifyMeasure(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ClinicalListLib cqmData) throws IOException{
		...
		try{
			...
			//--------------------------------------------------------------------//
			String str1=getText(selenium,"//div[@id='collapsableTitle0061']/div[3]");
			...
			String firstEncounterDate=month+date;
			String secondEncounterDate=(month-1)+date;
			
			
			
			assertTrue(enterDate(selenium,txtEncounterDate,firstEncounterDate),"Could not enter encounter date", selenium, ClassName, MethodName);
			...
			*/
			...
			assertTrue(createProblemListforMeasure0061(selenium,problemData),"Creation failed", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);*/
			...
			medicationData.testCaseId = "TC_PSM_040";
			...
			waitForPageLoad(selenium);
			selectValueFromAjaxList(selenium,ajxProvider1,cqmData.provider);
			assertTrue(enterDate(selenium,txtEncounterDate,secondEncounterDate),"Could not enter encounter date", selenium, ClassName, MethodName);
			
			ChartPreVisitLib vitalsData = new ChartPreVisitLib();
			vitalsData.workSheetName = "CreateVitals";
			vitalsData.testCaseId = "TC_CV_041";
			...
			waitForPageLoad(selenium);
			waitForPageLoad(selenium);
			String str2=getText(selenium,"//div[@id='collapsableTitle0061']/div[3]");
			waitForPageLoad(selenium);
