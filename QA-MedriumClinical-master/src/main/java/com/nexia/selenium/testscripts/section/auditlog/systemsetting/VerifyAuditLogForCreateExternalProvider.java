...
public class VerifyAuditLogForCreateExternalProvider extends AbstractAuditLog {
	...
	public void createNewExternalProvider(String seleniumHost, int seleniumPort,String browser, String webSite,String userAccount) throws Exception {
		...
		createExternalProvidersForAuditLog(seleniumHost, seleniumPort, browser, webSite, providerData, userAccount);
	}
	...
	public boolean createExternalProvidersForAuditLog(String seleniumHost, int seleniumPort,String browser, String webSite, AuditLogLib providerData,String userAccount) throws Exception{
