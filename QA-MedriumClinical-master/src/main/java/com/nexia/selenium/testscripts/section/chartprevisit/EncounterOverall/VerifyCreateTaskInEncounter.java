...
public class VerifyCreateTaskInEncounter extends AbstractTaskManagement{
	...
	public void createTaskInEncounter(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		verifyCreateTask(seleniumHost, seleniumPort, browser, webSite, userAccount,createPatientTask);
	}
	/*************************************************************************************************** 
	* @purpose        verify Create Task In Encounter 
	...
	***************************************************************************************************/
	...
	public boolean verifyCreateTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, TaskManagementLib createPatientTask ) throws IOException{
		...
		try{
			...
			//--------------------------------------------------------------------//
			//  Step-5: verify created Task //
			//--------------------------------------------------------------------//
			
			if(!verifyCreateTask(selenium,createPatientTask)){
	...
	public boolean verifyCreateTask(Selenium selenium, TaskManagementLib createPatientTask){
		...
		if(!getText(selenium, lblEncounterTask).contains(createPatientTask.taskName)){
			return false;
		}
		return true;
	}
