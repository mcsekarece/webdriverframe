...
public class VerifyCancelInteractionWarningOnMySettings extends AbstractClinicalSettings {
	...
	public void verifyCanceWarning(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
