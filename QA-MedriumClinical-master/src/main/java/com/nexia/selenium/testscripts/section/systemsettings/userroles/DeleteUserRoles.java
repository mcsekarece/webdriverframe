...
public class DeleteUserRoles extends AbstractSystemSettingsTest{
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Delete User Role")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void deleteUserRoles(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		deleteUserRoles(seleniumHost, seleniumPort, browser, webSite, userAccount, userRoleData);
	}
	/**
	 * deleteUserRoles
	 ...
	 * @since  	    Oct 16, 2012
	 */
	public boolean deleteUserRoles (String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, SystemSettingsLib userRoleData) throws IOException{
		...
		try{
			...
			assertTrue(!selenium.isTextPresent(userRoleData.userRole+uniqueName), 
					"Delete User Role Failed", selenium, ClassName, MethodName);
