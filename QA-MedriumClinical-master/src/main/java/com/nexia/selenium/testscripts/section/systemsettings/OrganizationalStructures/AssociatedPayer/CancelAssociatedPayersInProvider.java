...
public class CancelAssociatedPayersInProvider extends AbstractSystemSettingsTest{
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Cancel a Associate Payer")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void cancelAssociatePayer(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		CancelPayers(seleniumHost, seleniumPort, browser, webSite, userAccount, providerData);
	}
	/**
	 * createProvider
	 ...
	 * @since  	    June 05, 2010
	 */
	public boolean CancelPayers(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, SystemSettingsLib providerData) throws Exception{
		...
		try{
			...
			payerData.testCaseId = "TC_AP_007";
