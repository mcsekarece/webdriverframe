...
public class RemoveAssociateUserInAdminPractice extends AbstractSystemSettingsTest{
	...
	public void removeAssociateUser(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		removeUserInPractice(seleniumHost, seleniumPort, browser, webSite, userAccount, pracData);
	}
	...
	***************************************************************************************************/
	...
	public boolean removeUserInPractice(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, SystemSettingsLib pracData) throws IOException{
		...
		try{
			...
			//--------------------------------------------------------------------//
			if(getText(selenium,lblUser1).contains(userName)){
				waitForPageLoad(selenium);
				returnValue= true;
			}else
				returnValue= false;
