...
public class DeleteSearchEntryForMatchOneOrMore extends AbstractClinicalList  {
	...
	public boolean verifyDeleteSingleEntry(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ClinicalListLib searchData) throws IOException{
		...
		try{
			...
			waitForPageLoad(selenium);
			assertTrue(!isElementPresent(selenium,lblSearchEntry1),"It is present", selenium, ClassName, MethodName);

			/*if(isElementPresent(selenium,lblSearchEntry1)){
				returnValue=false;
			}*/
