...
public class VerifyAddSocioEconomicInUnfinishedItemForCAView extends AbstractHomeTest{
	@Test(groups = {"RegressionCA","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding a New patient socio economic For Ca View")
	...
	/*************************************************************************************************** 
	* @purpose        To verify Create Socio Economic For CA View 
	* @action 		  verifying Create Socio Economic For CA View 
	* @author         Aspire QA
	* @state          Developing
	* @useraccount    Both
	* @since  	      July 11, 2013
	***************************************************************************************************/
	...
	public boolean createNewSocioEconomicCAView(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, HomeLib sEconomicData) throws Exception{
		...
		try{
			...
			sEconomicData1.workSheetName = "SocioEconomicCAView";
			sEconomicData1.testCaseId = "TC_SEV_003";
			sEconomicData1.fetchHomeTestData();
			
			assertTrue(createSocioEconomic(selenium,sEconomicData1, userAccount),"Socio-Economic creation Failed", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
			...
			//--------------------------------------------------------------------//
			if(!verifyStoredValuesCreateSocioEconomics(selenium,sEconomicData1, userAccount)){
