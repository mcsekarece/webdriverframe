...
public class VerifyClearFieldForDiagnosticImaging extends AbstractChartPreVisit {
	@Test(groups =  {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for ordering Labs")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyClearField(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
	...
	public boolean createDiOrder(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ChartPreVisitLib orderData) throws IOException{
		...
		try{
			...
			click(selenium,lblDiorderDetails);
			waitForPageLoad(selenium);
			
				if(!getValue(selenium, lblDiorderDetails).contains(orderData.labTestName)){
					returnValue=true;
				}else{
					Assert.fail("The Details is not getting displayed");
				}
