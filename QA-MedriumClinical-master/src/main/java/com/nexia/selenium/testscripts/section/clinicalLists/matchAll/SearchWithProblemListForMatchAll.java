...
public class SearchWithProblemListForMatchAll extends AbstractClinicalList{
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient with problem and time condition option as since always")
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient with problem and time condition as within the last ")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient with problem and time condition as after this date")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient who has problem when time condition is since always and within the last")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient who has problem when time condition is since always and after this date")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient who has problem when time condition is within the last and after date Medication")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient who has problem when time condition is since always , within the last and after date Medication")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient who has multiple problems")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	public boolean searchProblemList(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ClinicalListLib clinicalProblemListData) throws IOException{
		...
		try{
			...
			assertTrue(deleteAllProblemList(selenium, clinicalProblemListData),"could not delete", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
			...
			waitForPageLoad(selenium);
			assertTrue(searchWithProblemList(selenium,clinicalProblemListData,"MatchAll",possition ),"could not display search results", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
	...
	public boolean searchProblemListWithMutipleOptions(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ClinicalListLib clinicalProblemListData) throws IOException{
		...
		try{
			...
			//--------------------------------------------------------------------//
			assertTrue(searchProblemListWithOptions(selenium,clinicalProblemListData,"MatchAll",possition ),"Search not proper", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
			waitForPageLoad(selenium);
			String st=getText(selenium,lblSearchResultLabel);
			String[] st1=st.split("\\s+");
