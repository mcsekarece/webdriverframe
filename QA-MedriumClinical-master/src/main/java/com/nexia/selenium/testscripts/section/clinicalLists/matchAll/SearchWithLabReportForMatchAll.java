...
public class SearchWithLabReportForMatchAll extends AbstractClinicalList{
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "To search a patient with lab report less than 500 and since always")
	...
	public void searchWithLabReportLessThanSinceAlways(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();ClinicalListLib labReportData = new ClinicalListLib();
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "To search a patient with lab report less than 500 and within the last")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "To search a patient with lab report less than 500 and after this date")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "To search a patient with lab report more than 10 and since always")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "To search a patient with lab report more than 10 and within the last")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "To search a patient with lab report more than 10 and after this date")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "To search a patient with lab report between 10 and 500 and since always")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "To search a patient with lab report between 10 and 500 and within the last")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "To search a patient with lab report between 10 and 500 and after this date")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "To search a patient with lab report which complies with the two search fields")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "To search a patient with two lab reports")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	public boolean searchLabReport(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ClinicalListLib labReportData) throws IOException{
		...
		try{
			...
			waitForPageLoad(selenium);
			assertTrue(click(selenium,btnAddNew),"Could not click the clinical list button", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
			selectValueFromAjaxList(selenium,String.valueOf(possition)+"andsearchTypeSuggestBoxsuggestBoxsuggestBox",labReportData.searchField);
			...
			if((labReportData.testCaseId.equals("TC_SLR_001"))||(labReportData.testCaseId.equals("TC_SLR_002"))||(labReportData.testCaseId.equals("TC_SLR_003"))){
				selectValueFromAjaxList(selenium,String.valueOf(possition)+"anddurationConditionSuggestBoxsuggestBoxsuggestBox",labReportData.duration);
			...
			waitForPageLoad(selenium);
			try{
				selenium.focus(lnkPatientOptionsLink);
				selenium.clickAt(lnkPatientOptionsLink, "");
			}catch(Exception e){
				selenium.focus(lnkPatientOptionsLink);
				selenium.clickAt(lnkPatientOptionsLink, "");
			}
			//assertTrue(click(selenium,lnkPatientOptionsLink),"Could not click the Patient Options");
			waitForPageLoad(selenium);
			...
			waitForPageLoad(selenium);
			/*if(isElementPresent(selenium,lnkLabEnterData))
			...
			assertTrue(enterDate(selenium,txtCdate,labReportData.date),"Could not click the clinical list button", selenium, ClassName, MethodName);
	...
	public boolean searchLabReportCombination(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ClinicalListLib labReportData) throws IOException{
		...
		try{
			...
			waitForPageLoad(selenium);
			assertTrue(click(selenium,btnNewSearch),"Could not click the clinical list button", selenium, ClassName, MethodName);
			assertTrue(click(selenium,btnAddClinicalSearch),"Could not click the clinical list button", selenium, ClassName, MethodName);
			selectValueFromAjaxList(selenium,String.valueOf(possition)+"andsearchTypeSuggestBoxsuggestBoxsuggestBox",labReportData.searchField);
			selenium.type(ajxLabResult,labReportData.test);
			//selenium.typeKeys(textboxName,valueForSelection);
			selenium.fireEvent(ajxLabResult,"keydown");
			...
			if(labReportData.testCaseId.equals("TC_SLR_010")){
				...
				click(selenium,currentItem); 
				selenium.clickAt(ajxLabResult,"");
				selectValueFromAjaxList(selenium,String.valueOf(possition)+"anddurationConditionSuggestBoxsuggestBoxsuggestBox",labReportData.duration1);
			...
			assertTrue(click(selenium,lnkLabEnterData),"Could not click the patient options link", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
