...
public class CreateBillingSettingSetUp extends AbstractBilling{
	@Test(groups = { "EndToEnd", "Developing", "firefox", "iexplore", "safari","default" }, description = "Test for Create Billing Set Up")
