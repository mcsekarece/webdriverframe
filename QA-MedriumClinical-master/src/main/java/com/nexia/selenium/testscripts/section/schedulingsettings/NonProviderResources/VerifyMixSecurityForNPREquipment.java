...
public class VerifyMixSecurityForNPREquipment extends AbstractSchedulingTest {
	...
	public boolean verifySecurity(Selenium selenium,SchedulingTestLib nonProviderEq,SystemSettingsLib userRoleData, String userAccount) throws IOException{
		boolean returnValue=true;
