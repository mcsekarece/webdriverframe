...
public class VerifySearchWithAndOrDoNotInclude extends AbstractClinicalList {
	...
	public boolean verifySearch(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ClinicalListLib ageData) throws Exception{
		...
		try{
			...
			//--------------------------------------------------------------------//
			assertTrue(click(selenium, btnAddNewCriteria), "Could not click on Add New button for Match All Filter", selenium, ClassName, MethodName);
			...
			assertTrue(type(selenium, String.valueOf(possition)+"anddurationIntegerMin", ageData.year1), "Could not enter minimum year", selenium, ClassName, MethodName);
			...
			selectValueFromAjaxList(selenium,ajxSex2CondtionForMatchAll,ageData.sex1);
			...
			selectValueFromAjaxList(selenium, String.valueOf(possition)+"excludesearchTypeSuggestBoxsuggestBoxsuggestBox", ageData.searchType4);
			selectValueFromAjaxList(selenium, String.valueOf(possition)+"excludedurationConditionSuggestBoxsuggestBoxsuggestBox", ageData.durationCondition2);
			assertTrue(type(selenium, String.valueOf(possition)+"excludedurationIntegerMin", ageData.year2), "Could not enter minimum year", selenium, ClassName, MethodName);
