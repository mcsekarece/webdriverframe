...
public class CreatePayersForEndToEnd extends AbstractSystemSettingsTest {	
	
	
	@Test(groups = {"EndToEnd","Developing","firefox", "iexplore", "safari", "default" }, description = "Test for Creating Payers For Portability")
	...
	***************************************************************************************************/
	...
	public boolean searchPayers(Selenium selenium, SystemSettingsLib createPayer) throws IOException{
	    ...
	    waitForPageLoad(selenium);
	    waitForPageLoad(selenium);
	    if(getText(selenium,lblListPayers).contains(createPayer.payerName)){
	    	return false;
	    }
