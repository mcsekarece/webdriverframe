...
public class VerifyLabReFile extends AbstractChartPreVisit{
	@Test(groups = {"AdvancedSmoke","Regression", "Approved","firefox", "iexplore", "safari", "default" }, description = "Test for verify lab re file")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyLabReFile(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		verifyLabReportReFile(seleniumHost, seleniumPort, browser, webSite, userAccount, orderData);
	}
	
	/**
	 * verifyLabReportReFile
	 * function to verify Lab report refile
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
	...
	public boolean verifyLabReportReFile(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ChartPreVisitLib orderData) throws IOException{
		...
		try{
			...
			//String x=date +" by "+ orderData.provider;
			assertTrue(selenium.isTextPresent("Lab report successfully refiled to "),"Lab report successfully message is not getting displayed", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
