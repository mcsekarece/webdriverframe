...
public class VerifyAuditLogForEditAllergy extends AbstractAuditLog {
	...
	public boolean addAllergy(String seleniumHost, int seleniumPort,String browser, String webSite,String userAccount, AuditLogLib allergyData){
		...
		try{
			...
			Assert.assertTrue(click(selenium,"link=Allergies"),"Could not click the Allergy link;More Details");
			waitForPageLoad(selenium);
			Assert.assertTrue(click(selenium,"link=Edit"),"Could not click the Edit Allergy link;More Details");
			waitForPageLoad(selenium);
			Assert.assertTrue(createAllergy(selenium,allergyData),"Creation failed");
			waitForPageLoad(selenium);
			...
			//--------------------------------------------------------------------//
			//  Step-9: Verify whether External Providers gets saved properly //
			//--------------------------------------------------------------------//
