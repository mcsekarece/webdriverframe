...
public class VerifyCreateLabOrderWithNotify extends AbstractChartPreVisit{
	...
	public void CreateALabOrder(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ChartPreVisitLib orderdata = new ChartPreVisitLib();
		orderdata.workSheetName = "OrderNotifyMe";
		orderdata.testCaseId = "TC_ON_005";
