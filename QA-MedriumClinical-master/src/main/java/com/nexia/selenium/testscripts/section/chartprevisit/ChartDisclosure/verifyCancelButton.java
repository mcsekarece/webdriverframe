...
public class verifyCancelButton extends AbstractChartPreVisit {
	
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyCancelButtonAfterSelectItemsCreateTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyCancelButtonAfterContinueCreateTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib chartDisclosureData = new ChartPreVisitLib();
		chartDisclosureData.workSheetName = "CreatePatientTask";
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyCancelButtonAfterFullincludeCreateTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib chartDisclosureData = new ChartPreVisitLib();
		chartDisclosureData.workSheetName = "CreatePatientTask";
		chartDisclosureData.testCaseId = "TC_CD_010";
		chartDisclosureData.fetchChartPreVisitTestData();
		verifyPopUp(seleniumHost, seleniumPort, browser, webSite, userAccount, chartDisclosureData);
	}
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	...
	public void verifyCancelButtonAfterSelectItemsPatientTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		ChartPreVisitLib chartDisclosureData = new ChartPreVisitLib();
		chartDisclosureData.workSheetName = "CreatePatientTask";
		chartDisclosureData.testCaseId = "TC_CD_011";
		chartDisclosureData.fetchChartPreVisitTestData();
		verifyPopUp(seleniumHost, seleniumPort, browser, webSite, userAccount, chartDisclosureData);
	}
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	...
	public void verifyCancelButtonAfterContinuePatientTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		ChartPreVisitLib chartDisclosureData = new ChartPreVisitLib();
		chartDisclosureData.workSheetName = "CreatePatientTask";
		chartDisclosureData.testCaseId = "TC_CD_012";
		chartDisclosureData.fetchChartPreVisitTestData();
		verifyPopUp(seleniumHost, seleniumPort, browser, webSite, userAccount, chartDisclosureData);
	}
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyCancelButtonAfterFullincludePatientTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib chartDisclosureData = new ChartPreVisitLib();
		chartDisclosureData.workSheetName = "CreatePatientTask";
		chartDisclosureData.testCaseId = "TC_CD_013";
		chartDisclosureData.fetchChartPreVisitTestData();
		verifyPopUp(seleniumHost, seleniumPort, browser, webSite, userAccount, chartDisclosureData);
	}
	...
	public boolean verifyPopUp(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ChartPreVisitLib chartDisclosureData) throws IOException{
		...
		try{
			...
			//creating new Chart Disclosure
			 ...
			 assertTrue(verifyChartDisclosureCancelButton(selenium, chartDisclosureData),"Cancel Button verification Failed", selenium, ClassName, MethodName);
	 ...
	 * @since May 07, 2014
	 */
	public boolean verifyChartDisclosureCancelButton(Selenium selenium,
			ChartPreVisitLib chartDisclosureData) throws IOException {
		
		try {
			if(chartDisclosureData.testCaseId.equals("TC_CD_008")||chartDisclosureData.testCaseId.equals("TC_CD_011")){ 
			 ...
			 if(chartDisclosureData.testCaseId.equals("TC_CD_009")||chartDisclosureData.testCaseId.equals("TC_CD_012")){
				 assertTrue(click(selenium,radIncludeFullChart),"Include Partial Chart Radio Button not Present", selenium , ClassName, MethodName);
				 waitForPageLoad(selenium);	
			 ...
			 assertTrue(isElementPresent(selenium,btnCancelChartItems),"Cancel Button not available", selenium , ClassName, MethodName);
			 assertTrue(click(selenium,btnCancelChartItems),"Could not click cancel button", selenium , ClassName, MethodName);
			 waitForPageLoad(selenium);	
			 if(isElementPresent(selenium,txtChartDLSInst)){
				 return true;
			 }else
				 return false;		 
