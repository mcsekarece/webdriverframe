...
public class AddNewDate extends AbstractBilling {
	...
	@Parameters({ "seleniumHost", "seleniumPort", "browser", "webSite",
			"userAccount" })
	public void addNewDate(String seleniumHost, int seleniumPort,
		...
		chargeEntryData.testCaseId = "TC_CE_018";
	...
	public boolean verifyAddNewDate(String seleniumHost,
		...
		try {
			...
			if (chargeEntryData.testCaseId.equals("TC_CE_018")) {
