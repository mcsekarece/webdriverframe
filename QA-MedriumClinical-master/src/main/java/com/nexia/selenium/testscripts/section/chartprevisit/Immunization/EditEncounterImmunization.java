...
public class EditEncounterImmunization extends AbstractChartPreVisit{
	/*@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for editing Encounter Immunization")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void editEncounterRefusedByPatient(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ChartPreVisitLib immunizationData = new ChartPreVisitLib();
		immunizationData.workSheetName = "CreateImmunization";
		immunizationData.testCaseId = "TC_CIM_033";
		immunizationData.fetchChartPreVisitTestData();
		
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		
		editEncounterImmunization(seleniumHost, seleniumPort, browser, webSite, userAccount, immunizationData);
	}*/
	
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for editing Encounter Immunization")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void editEncounterAdministered(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ChartPreVisitLib immunizationData = new ChartPreVisitLib();
		immunizationData.workSheetName = "CreateImmunization";
		immunizationData.testCaseId = "TC_CIM_034";
		immunizationData.fetchChartPreVisitTestData();
	...
	public void editEncounterImmunization(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ChartPreVisitLib immunizationData = new ChartPreVisitLib();
		immunizationData.workSheetName = "CreateImmunization";
		immunizationData.testCaseId = "TC_CIM_035";
		immunizationData.fetchChartPreVisitTestData();
	...
	/**
	 * editEncounterImmunization
	 * function to edit Encounter Immunization
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
	...
	public boolean editEncounterImmunization(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ChartPreVisitLib immunizationData) throws IOException{
		...
		try{
			...
			//--------------------------------------------------------------------//
			assertTrue(click(selenium,lnkEncounterImmunization),"Could not find the immunization link", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
			...
			waitForPageLoad(selenium);
			assertTrue(clickAt(selenium,lnkImmunEncounterdetails,""),"Could not click", selenium, ClassName, MethodName);
			...
			if(immunizationData.testCaseId.equals("TC_CIM_033")){
				immunizationData.workSheetName = "CreateImmunization";
				immunizationData.testCaseId = "TC_CIM_006";
				immunizationData.fetchChartPreVisitTestData();
			}else if(immunizationData.testCaseId.equals("TC_CIM_034")){
				immunizationData.workSheetName = "CreateImmunization";
				immunizationData.testCaseId = "TC_CIM_069";
				immunizationData.fetchChartPreVisitTestData();
			}else if(immunizationData.testCaseId.equals("TC_CIM_035")){
				immunizationData.workSheetName = "CreateImmunization";
