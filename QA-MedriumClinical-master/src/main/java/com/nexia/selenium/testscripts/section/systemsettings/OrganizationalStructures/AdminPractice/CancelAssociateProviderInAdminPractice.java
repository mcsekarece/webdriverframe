...
public class CancelAssociateProviderInAdminPractice extends AbstractSystemSettingsTest{
	...
	public void cancelAssociateProvider(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		cancelProviderInPractice(seleniumHost, seleniumPort, browser, webSite, userAccount, pracData);
	}
	...
	***************************************************************************************************/
	...
	public boolean cancelProviderInPractice(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, SystemSettingsLib pracData) throws IOException{
