...
public class DeleteSearchEntryForDoNotInclude extends AbstractClinicalList  {
	...
	public boolean verifyDeleteSingleEntry(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ClinicalListLib searchData) throws IOException{
		...
		try{
			...
			waitForPageLoad(selenium);
			assertTrue(!isElementPresent(selenium,lblSearchEntry),"Search Entry found", selenium, ClassName, MethodName);

			/*if(isElementPresent(selenium,lblSearchEntry)){
				returnValue=false;
			}*/
