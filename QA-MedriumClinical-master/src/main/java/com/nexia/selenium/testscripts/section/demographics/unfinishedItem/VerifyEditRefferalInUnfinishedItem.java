...
public class VerifyEditRefferalInUnfinishedItem extends AbstractHomeTest{
	
	@Test(groups = {"AdvancedSmoke","Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Edit Refferal In UnfinishedItem")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyEditRefferalInUnfinishedItem(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		HomeLib refData = new HomeLib();
		refData.workSheetName = "CreateReferral";
		refData.testCaseId = "TC_CRL_009";
	...
	***************************************************************************************************/
	...
	public boolean verifyAddRefferalInUnfinishedItem(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, HomeLib refData) throws Exception{
		...
		String currentUnfinishedItem="Edit Referrals for";
		...
		try{
			...
			assertTrue(click(selenium, lnkEditReferral),"Could not find edit referral button; More Details:" + refData.toString(), selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
			...
			if(isElementPresent(selenium,lnkOpenUnfinishedItem)){				
				assertTrue(click(selenium, lnkOpenUnfinishedItem),"Could not click Open link",selenium, ClassName, MethodName);
	       ...
	       // Complete the unfinished item
			...
			//---------------------------------------------------------------------------//
			//  Step-11: Verifying Completed unfinished item Details are saved properly  //
			//---------------------------------------------------------------------------//
