...
public class CreateProgramGroup extends AbstractSchedulingTest{
 
	@Test(groups = {"SmokeSingle","SingleThread","Approved", "firefox", "iexplore", "safari", "default" }, description = "Test For Create Progarm With Personal Development")
	...
	@Test(groups = {"SmokeSingle","SingleThread","Approved", "firefox", "iexplore", "safari", "default" }, description = "Test For Create Progarm With Day service")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
