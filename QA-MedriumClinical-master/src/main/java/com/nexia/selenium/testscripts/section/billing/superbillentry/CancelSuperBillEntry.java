...
public class CancelSuperBillEntry extends AbstractBilling{
	@Test(groups = {"RegressionCA","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verify Cancel Button in Super Bill Entry Page")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyCancelSuperBillEntry(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		verifyCancelButton(seleniumHost, seleniumPort, browser, webSite, userAccount, superBillData);
	}
	
	/*************************************************************************************************** 
	* @purpose        To verify Cancel button in Super bill Entry page 
	* @action 		  verify Cancel button in Super bill Entry page 
	* @expected       To Ensure that the Cancel button in Super bill Entry page 
	...
	* @since  	      May 31, 2014
	***************************************************************************************************/
	public boolean verifyCancelButton(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, BillingLib superBillData) throws IOException{
		...
		try {
			...
			if(!isElementPresent(selenium,chartVisit.lnkAllergy)){
				Assert.fail("Summary page is not getting displayed");
			}else
				returnValue = true;
