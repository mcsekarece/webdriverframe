...
public class VerifyAuditLogForEditDirectories extends AbstractAuditLog{
	...
	public void editNewDirectories(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		directoriesData.testCaseId = "TC_ALD_001";
		directoriesData.fetchHomeTestData();
		editDirectories(seleniumHost, seleniumPort, browser, webSite, directoriesData, userAccount);
	}
	...
	public boolean editDirectories(String seleniumHost, int seleniumPort,String browser, String webSite, AuditLogLib directoriesData,String userAccount) throws IOException{
		...
		try{
			...
			//--------------------------------------------------------------------//
			directoriesData.workSheetName = "AuditLogForCreateDirectories";
			directoriesData.testCaseId = "TC_ALD_002";
			directoriesData.fetchHomeTestData();
			
			Assert.assertTrue(click(selenium,"editButton"),"Could not click the edit button;More details:"+directoriesData.toString());
			waitForPageLoad(selenium);
