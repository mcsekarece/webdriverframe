...
public class VerifyHideAndShowOptionInRecordSessionNote extends AbstractSchedulingTest{
	...
	public void hideAndShowOptionInRecordSessionNote(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		verifyHideAndShowDetails(seleniumHost, seleniumPort, browser, webSite, userAccount, pDGData);
	}
	
	/*************************************************************************************************** 
	* @purpose        To Verify Hide And Show Option In Record Session Note
	* @action 		  Verify Hide And Show Option In Record Session Note
	* @expected       To Ensure that the Verify Hide And Show Option In Record Session Note works fine 
	...
	* @since  	      Nov 10, 2013
	***************************************************************************************************/
	public boolean verifyHideAndShowDetails(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, SchedulingTestLib pDGData) throws Exception{
		...
		try{
			...
			//Hide button is getting displayed
			assertTrue(selenium.isTextPresent("Hide"),"Hide button", selenium, ClassName, MethodName);
