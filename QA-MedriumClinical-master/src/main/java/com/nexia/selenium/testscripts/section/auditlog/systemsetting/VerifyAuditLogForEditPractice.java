...
public class VerifyAuditLogForEditPractice extends AbstractAuditLog{
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding a New patient Case")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite"})
	public void editPractice(String seleniumHost, int seleniumPort,String browser, String webSite,String userAccount) throws Exception {
		...
		editPractice(seleniumHost, seleniumPort, browser, webSite, practiceData, userAccount);
	}
	...
	public boolean editPractice(String seleniumHost, int seleniumPort,String browser, String webSite, AuditLogLib practiceData,String userAccount) throws Exception{
		...
		try{
			...
			//---------------------------------------------------------- ---------//
			//  Step-4: Edit Practice                                        //
			//--------------------------------------------------------------------//
			practiceData.workSheetName = "AuditLogForCreatePractice";
			practiceData.testCaseId = "TC_ALP_002";
			practiceData.fetchHomeTestData();
			...
			if(!verifyStoredValuesForCreatePractice(selenium,practiceData)){
				Assert.fail("User details not saved properly; More Details :"+ practiceData.toString());
				returnValue=false;
			}if(!verifyStoredValuesForEditPractice(selenium,practiceData)){
				Assert.fail("User details not saved properly; More Details :"+ practiceData.toString());
				returnValue=false;
			}else{
				return returnValue;
	...
	public boolean verifyStoredValuesForCreatePractice(Selenium selenium,AuditLogLib auditData){
	...
	public boolean verifyStoredValuesForEditPractice(Selenium selenium,AuditLogLib auditData){
