...
public class SearchWithProblemListForMatchOneOrMore extends AbstractClinicalList{
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient who has problem when time condition is since always or within the last")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient who has problem when time condition is since always or after this date")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient who has problem when time condition is within the last or after date Medication")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient who has problem when time condition is since always or within the last or after date Medication")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for searching a patient who has either of two problems")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	...
	public boolean searchProblemList(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ClinicalListLib clinicalProblemListData) throws IOException{
		...
		try{
			...
			waitForPageLoad(selenium);
			assertTrue(searchWithProblemList(selenium,clinicalProblemListData,"OneOrMore",possition),"could not display search results", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
	...
	public boolean searchProblemListWithMutipleOptions(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ClinicalListLib clinicalProblemListData) throws IOException{
		...
		try{
			...
			assertTrue(searchProblemListWithOptions(selenium,clinicalProblemListData,"OneOrMore",possition),"Search not proper", selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
			//--------------------------------------------------------------------//
			...
			assertTrue(searchPatientNexiaForProviderHomePage(selenium,clinicalProblemListData.patientId),"Search Failed", selenium, ClassName,MethodName);
			waitForPageLoad(selenium);
			waitForPageLoad(selenium);
