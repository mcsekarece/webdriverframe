...
public class VerifyActionsLink extends AbstractChartPreVisit {
	
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyEditRequestCreateTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		chartDisclosureData.testCaseId = "TC_CD_018";
	...
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyEditSelectionCreateTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib chartDisclosureData = new ChartPreVisitLib();
		chartDisclosureData.workSheetName = "CreatePatientTask";
		chartDisclosureData.testCaseId = "TC_CD_019";
		chartDisclosureData.fetchChartPreVisitTestData();
		verifyPopUp(seleniumHost, seleniumPort, browser, webSite, userAccount, chartDisclosureData);
	}
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyEditRequestPatientTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib chartDisclosureData = new ChartPreVisitLib();
		chartDisclosureData.workSheetName = "CreatePatientTask";
		chartDisclosureData.testCaseId = "TC_CD_020";
		chartDisclosureData.fetchChartPreVisitTestData();
		verifyPopUp(seleniumHost, seleniumPort, browser, webSite, userAccount, chartDisclosureData);
	}
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Adding Allergy")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyEditSelectionPatientTask(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		ClassName=this.getClass().getName().substring(39);	
		MethodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib chartDisclosureData = new ChartPreVisitLib();
		chartDisclosureData.workSheetName = "CreatePatientTask";
		chartDisclosureData.testCaseId = "TC_CD_021";
		chartDisclosureData.fetchChartPreVisitTestData();
		verifyPopUp(seleniumHost, seleniumPort, browser, webSite, userAccount, chartDisclosureData);
	}
	...
	public boolean verifyPopUp(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ChartPreVisitLib chartDisclosureData) throws IOException{
		...
		try{
			...
			waitForPageLoad(selenium);
			 if(chartDisclosureData.testCaseId.equals("TC_CD_018")||chartDisclosureData.testCaseId.equals("TC_CD_019")){
			...
			//creating new Chart Disclosure
			 ...
			 selenium.keyPress(txtSearchBox1, "\\13"); waitForPageLoad(selenium);	
			 ...
			 assertTrue(verifyChartDisclosureActionsLink(selenium, chartDisclosureData),"Cancel Button verification Failed", selenium, ClassName, MethodName);
	 ...
	 * @since May 07, 2014
	 */
	public boolean verifyChartDisclosureActionsLink(Selenium selenium,
		...
		try {
			...
			waitForPageLoad(selenium);	
			 ...
			 assertTrue(isElementPresent(selenium,lnkActions),"Cancel Button not available", selenium , ClassName, MethodName);
			 assertTrue(click(selenium,lnkActions),"Could not click cancel button", selenium , ClassName, MethodName);
			 waitForPageLoad(selenium);	
			 if(chartDisclosureData.testCaseId.equals("TC_CD_018")||chartDisclosureData.testCaseId.equals("TC_CD_020")){
				 assertTrue(isElementPresent(selenium,lnkEditRequest),"Edit Request Link not present", selenium , ClassName, MethodName);
				 assertTrue(click(selenium,lnkEditRequest),"Could not click Edit Request Link", selenium , ClassName, MethodName);				 
				 waitForPageLoad(selenium);
				 assertTrue(isElementPresent(selenium,txtChartDLSInst),"Edit Request link not working", selenium , ClassName, MethodName);
			 }else{
				 assertTrue(isElementPresent(selenium,lnkEditSelection),"Edit Request Link not present", selenium , ClassName, MethodName);
				 assertTrue(click(selenium,lnkEditSelection),"Could not click Edit Request Link", selenium , ClassName, MethodName);
				 waitForPageLoad(selenium);
				 assertTrue(isElementPresent(selenium,radIncludePartialChart),"Edit Selection Link not working", selenium , ClassName, MethodName);
