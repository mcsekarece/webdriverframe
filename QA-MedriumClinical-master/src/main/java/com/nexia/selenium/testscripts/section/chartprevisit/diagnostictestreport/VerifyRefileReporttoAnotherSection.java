...
public class VerifyRefileReporttoAnotherSection extends  AbstractChartPreVisit{

	@Test(groups = {"SingleThread","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Verify Refile Report to Another Section")
	...
	/**
	 * Verify Refile Report to Another Section
	 * function to Verify Refile Report to Another Section
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
	...
	public boolean createDiagnosticTestReport(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ChartPreVisitLib diData) throws IOException{
		...
		try{
			...
			//--------------------------------------------------------------------//
		   //  Step-8 : verify Unsigned Refile to Another sectionj 
		   //--------------------------------------------------------------------//

			assertTrue(verifyRefileReporttoAnotherSection(selenium,diData,diData1,userAccount),"Verify Report Details to another section failed", selenium, ClassName,MethodName);
			waitForPageLoad(selenium);
...
public boolean verifyRefileReporttoAnotherSection(Selenium selenium,ChartPreVisitLib diData, ChartPreVisitLib diData1, String userAccount) throws IOException{
