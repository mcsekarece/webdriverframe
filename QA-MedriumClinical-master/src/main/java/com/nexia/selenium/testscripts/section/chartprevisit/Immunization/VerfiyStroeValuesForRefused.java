...
public class VerfiyStroeValuesForRefused extends AbstractChartPreVisit{
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for verifing Stroe Valued for Refused")
	...
	public void verifyStoreValuesForImmunization(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		immunizationData.testCaseId = "TC_CIM_037";
	...
	public boolean verifyStoreValues(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, ChartPreVisitLib immunizationData) throws IOException{
		...
		try{
			...
			assertTrue(verifyStoredValueInImmunization(selenium,immunizationData,userAccount),"Immunization details not saved properly; More Details :", selenium, ClassName, MethodName);
			
			assertTrue(selenium.isTextPresent("REFUSED"),"Immunization details not saved properly; More Details :", selenium, ClassName, MethodName);
	...
	public boolean verifyStoredValueInImmunization(Selenium selenium,ChartPreVisitLib immunizationData,String account) throws IOException{
		...
		//System.out.println(getText(selenium,lblCollapseView1));
		if (account.equals(CAAccount)) {
			assertTrue(selenium.isTextPresent(immunizationData.immunizationCA),""+"Immunization Data Not Present",selenium, ClassName, MethodName);
					}
		else	{

			assertTrue(selenium.isTextPresent(immunizationData.vaccineUS),""+"Immunization Data Not Present",selenium, ClassName, MethodName);
		}
