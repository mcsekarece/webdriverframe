...
public class VerifyTabInCheckInAssist extends AbstractOperationsTest{
	@Test(groups = {"Regression","Review","firefox", "iexplore", "safari", "default" }, description = "VerifyTabbingOrderForCheckInAssist")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void verifyTabInCheckInAssist(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount)throws Exception{
		...
		verifyTabInCheckInAssist(seleniumHost, seleniumPort, browser, webSite, userAccount,checkInAssistTestData);
	}
	
	/*************************************************************************************************** 
	* @purpose        To verify Tabbing Order For Patient CheckIn Assistant
	* @action 		  verifying Tabbing Order For Patient CheckIn Assistant
	* @author         Aspire QA
	 * @throws IOException 
	* @state          Developing
	* @useraccount    Both
	* @since  	      July 05, 2013
	***************************************************************************************************/
	public boolean verifyTabInCheckInAssist(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount,OperationsTestLib checkInAssistTestData) throws IOException{
	...
	public boolean  verifyStoreValues(Selenium selenium,OperationsTestLib createResourceCalData){
		...
		if(!getText(selenium,lblResourceCalendarSummaryArea).toLowerCase(new java.util.Locale("en","US")).trim().contains(createResourceCalData.resource.trim().toLowerCase(new java.util.Locale("en","US")))){
			 return false;                       
		 }
