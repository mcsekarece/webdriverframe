...
public class VerifyHoldOnClaimStatus extends AbstractSystemSettingsTest{
	@Test(groups = {"Regression","Approved","firefox", "iexplore", "safari", "default" }, description = "Test for Hold a Associate Payer")
	@Parameters( { "seleniumHost", "seleniumPort", "browser", "webSite", "userAccount"})
	public void holdClaimsPayer(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount) throws Exception {
		...
		verifyHoldClaim(seleniumHost, seleniumPort, browser, webSite, userAccount, providerData);
	}
	
	/**
	 * verifyHoldCliam
	 * function to verify Hold Cliam
	 * @param 		seleniumHost
	 * @param 		seleniumPort
	 * @param 		browser
	 * @param 		webSite
	 ...
	 * @since  	    Feb 22, 2014
	 */
	public boolean verifyHoldClaim(String seleniumHost, int seleniumPort,String browser, String webSite, String userAccount, SystemSettingsLib providerData) throws Exception{
		...
		try{
			...
			// --------------------------------------------------------------------//
			assertTrue(click(selenium,billingData.lnkOnHold),"Could not click the On Hold Claims Queue",selenium, ClassName, MethodName);
			waitForPageLoad(selenium);
			...
			// --------------------------------------------------------------------//
			if(!verifyHoldClaimsDetails(selenium, postChargeEntry,payerData,providerPayerData, providerData)){
	...
	public boolean verifyHoldClaimsDetails(Selenium selenium,BillingLib postChargeEntry,HomeLib payerData,SystemSettingsLib providerPayerData,SystemSettingsLib providerData ){
		AbstractBilling billingData = new AbstractBilling();
