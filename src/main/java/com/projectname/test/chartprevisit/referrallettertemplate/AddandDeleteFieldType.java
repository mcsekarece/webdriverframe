...
public class AddandDeleteFieldType  extends TestBaseClass{
	...
	public void validateFieldTypeAddDeleteFunction(String userAccount,String webSite,String browser, String seleniumHost, String seleniumPort) throws Exception {
		...
		validateFieldTypeAddDeleteFunction(userAccount, letterTemplateTestData, webSite, browser, seleniumHost, seleniumPort);
	}
	private boolean validateFieldTypeAddDeleteFunction(String userAccount,ChartPreVisitLib letterTemplateTestData, String webSite, String browser, String seleniumHost, String seleniumPort) throws Exception {
		try
		{
			//--------------------------------------------------------------------//
			...
			templateSettingsPage.verifyPraticeFieldTypesAddDelete(driver,letterTemplatePage,letterTemplateTestData);
			//--------------------------------------------------------------------//
			...
			letterTemplateTestData.fetchChartPreVisitTestData();
			templateSettingsPage.verifyPatientPayersFieldTypesAddDelete(driver,letterTemplatePage,letterTemplateTestData);
