...
public class AddNewReferralLetterWithPatientPayers extends TestBaseClass{
	...
	public void addNewReferralLetterWithPatientPayers(String userAccount,String webSite,String browser, String seleniumHost, String seleniumPort) throws Exception {
		...
		addNewReferralLetterWithPatientPayers(userAccount, letterTemplateTestData, webSite, browser, seleniumHost, seleniumPort);
	}
	private boolean addNewReferralLetterWithPatientPayers(String userAccount,ChartPreVisitLib letterTemplateTestData, String webSite, String browser, String seleniumHost, String seleniumPort) throws Exception {
		try
		{
			//--------------------------------------------------------------------//
			...
			//--------------------------------------------------------------------//
			//  Step-4: Verify Letter Template     				 				  //
			//--------------------------------------------------------------------//
			templateSettingsPage.verificationAfterSaveTemplate(driver,letterTemplatePage,letterTemplateTestData);
