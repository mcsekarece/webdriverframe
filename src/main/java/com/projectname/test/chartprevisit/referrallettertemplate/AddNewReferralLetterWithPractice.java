...
public class AddNewReferralLetterWithPractice extends TestBaseClass{
	...
	public void addNewReferralLetterWithPractice(String userAccount,String webSite,String browser, String seleniumHost, String seleniumPort) throws Exception {
		...
		addNewReferralLetterWithPractice(userAccount, letterTemplateTestData, webSite, browser, seleniumHost, seleniumPort);
	}
	private boolean addNewReferralLetterWithPractice(String userAccount,ChartPreVisitLib letterTemplateTestData, String webSite, String browser, String seleniumHost, String seleniumPort) throws Exception {
		try
		{
			//--------------------------------------------------------------------//
