...
public class EndToEndVisitEight extends TestBaseClass{
	...
	public void endToEndReferralEight(String userAccount,String webSite, String browser, String seleniumHost, String seleniumPort) throws Exception 
	{		
		className=this.getClass().getName().substring(39);	
		methodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		SchedulingTestLib schedulingData = new SchedulingTestLib();
		schedulingData.workSheetName = "VisitsEndToEnd";
		schedulingData.testCaseId = "TC_ETE_008";
		schedulingData.fetchSchedulingTestData();
		voidChargeAtClaimLevel(schedulingData, userAccount);
	}
	
	/**
	 * Void Charge at claim level
	...
	public boolean voidChargeAtClaimLevel(SchedulingTestLib schedulingData, String userAccount) {
		...
		try{
			...
			billingHistoryPage.voidFirstClaim(billingChargesPage);
