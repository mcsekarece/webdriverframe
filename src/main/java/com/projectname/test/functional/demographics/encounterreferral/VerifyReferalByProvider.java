...
public class VerifyReferalByProvider extends TestBaseClass{
	...
	@Test(retryAnalyzer = RetryRule.class, groups = { "Regression" }, description = "Test for Verify Referral By Provider Option")
	@Parameters({"userAccount","webSite","browser","seleniumHost","seleniumPort"})

	public void verifyReferalByProvider(String userAccount,String website,String browser,String seleniumHost,String seleniumPort) throws Exception {
		className=this.getClass().getName().substring(39);	
		methodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		ChartPreVisitLib referralData = new ChartPreVisitLib();
		referralData.workSheetName = "ImplementReferrals";
		referralData.testCaseId = "TC_IRL_011";
		referralData.fetchChartPreVisitTestData();
		verifyReferalByProviderOption(referralData,userAccount);
}
	
	/**
     * verifyReferalByProviderOption - VEL-5549
     * To Verify Referal By Provider Option
     * @param referralData
	...
	public boolean verifyReferalByProviderOption(ChartPreVisitLib referralData, String userAccount) throws Exception{
