...
public class EndToEndVisitTen extends TestBaseClass{
	...
	public void endToEndReferralTen(String userAccount,String webSite,String browser, String seleniumHost, String seleniumPort) throws Exception 
	{		
		className=this.getClass().getName().substring(39);	
		methodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		SchedulingTestLib schedulingData = new SchedulingTestLib();
		schedulingData.workSheetName = "VisitsEndToEnd";
		schedulingData.testCaseId = "TC_ETE_010";
	...
	public boolean postChargeB(SchedulingTestLib schedulingData, String userAccount) {
		...
		try{
			...
			billingData.testCaseId = "TC_CE_069";
