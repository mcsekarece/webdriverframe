...
public class VerifyDonotMoveToSuperBillPage extends TestBaseClass{
	...
	public void verifyDonotMoveToSuperBillPage(String userAccount,String website,String browser,String seleniumHost,String seleniumPort) throws Exception {
	 ...
	 methodName= Thread.currentThread().getStackTrace()[1].getMethodName();
		...
		probData.fetchChartPreVisitTestData();
	     verifyDonotMoveToSuperBillPage(probData,userAccount);
}
	...
	public boolean verifyDonotMoveToSuperBillPage(ChartPreVisitLib probData, String userAccount) throws Exception{
