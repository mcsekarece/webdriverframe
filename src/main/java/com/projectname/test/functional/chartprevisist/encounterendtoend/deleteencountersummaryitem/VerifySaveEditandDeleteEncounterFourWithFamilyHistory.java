...
public class VerifySaveEditandDeleteEncounterFourWithFamilyHistory extends TestBaseClass {
	...
	@Test(retryAnalyzer = RetryRule.class, groups = { "Regression" }, description = "Test for Verify Save Edit and Delete Encounter Four with Family History")
	@Parameters({"userAccount","webSite","browser","seleniumHost","seleniumPort"})
	
	public void verifySaveEditandDeleteEncounterFourWithFamilyHistory(String userAccount,String website,String browser,String seleniumHost,String seleniumPort) throws Exception {
	 ...
	 verifySaveEditandDeleteEncounterFourWithFamilyHistory(familyHistoryData,userAccount);
}

	/**
     * VerifySaveEditandDeleteEncounterFour
     * To Verify function Save Edit and Delete Encounter Four with  FamilyHistory
     * @param familyHistoryData(Family History details to be added )
     * @param userAccount(Application Environment)
     * @since  May 25, 2015
     */

	public boolean verifySaveEditandDeleteEncounterFourWithFamilyHistory(ChartPreVisitLib familyHistoryData, String userAccount) throws Exception{
		...
		try{			
			...
			logTitleMessage("Add Family History in summary page");
			...
			logTitleMessage("Sucessfully Added Family History  in summary page");

			//--------------------------------------------------------------------//
			//  Step-7:Begin an Encounter and Edit Family History on encounter page //
			//--------------------------------------------------------------------//		
			...
			logTitleMessage("Family History edit A --> B in encounter successful");
			...
			//--------------------------------------------------------------------//
			//  Step-9: Edit Family History from B --> C in Summary				  //
			//--------------------------------------------------------------------//		
			...
			//----------------------------------------------------------------------------//
			//  Step-11:  Edit the Family History  C in encounter page      		      // 
			//---------------------------------------------------------------------------//		
			...
			//--------------------------------------------------------------------//
			//  Step-13:Verify Family History details C in Summary			      //
			//--------------------------------------------------------------------//		
		
			logTitleMessage("Verify Family History details C in Summary");
			patientChartPage.clickSummaryTab(driver);
			patientChartPage.verfiyFamilyHistoryInSummary(driver, familyHistoryData2);
			logTitleMessage("Successfully verified the Family History details C in Summary");
