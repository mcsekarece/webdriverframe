...
public class VerifyEditLabOrderTest extends TestBaseClass{
	...
	@Test(retryAnalyzer = RetryRule.class, groups = { "Regression" }, description = "Test for Verify Edit Lab Order Test, Ticket = VEL-2209" )
	@Parameters({"userAccount","webSite","browser","seleniumHost","seleniumPort"})
	public void verifyEditLabOrderTest(String userAccount,String website,String browser,String seleniumHost,String seleniumPort)  throws Exception 
	 {
	...
	public boolean createLabOrder(ChartPreVisitLib diData,String userAccount) throws Exception {
		...
		try{
	        ...
	        //-------------------------------------------------------------------- //
		    //  Step-8: Edit the Lab Order Test Names		 					 // 
		    //--------------------------------------------------------------------//
	        
	        diData.workSheetName = "CreateLabOrder";
			diData.testCaseId = "TC_NLO_002";
			diData.fetchChartPreVisitTestData();
	        
	        logTitleMessage(" Edit the Lab Order Test Names");
	        patientChartPage.editLabOrderTest(driver,diData,encounterPage,labOrderPage);
	        logTitleMessage("Sucessfully  Edited the Lab Order Test Names ");
		     
	       //--------------------------------------------------------------------//
		   //  Step-9:  View previous the Lab Order 				      		  // 
	       //--------------------------------------------------------------------//	
		   ...
		   //-------------------------------------------------------------------- //
		   //  Step-10: Verify Edited values the Lab Order Test Names			 // 
		   //--------------------------------------------------------------------//
		        
       	     logTitleMessage("Verify Edited values the Lab Order Test Names");
		     patientChartPage.verifyNewOrderLabTest(driver,diData,encounterPage,labOrderPage);
		     logTitleMessage("Sucessfully Verify Edited values the Lab Order Test Names");
