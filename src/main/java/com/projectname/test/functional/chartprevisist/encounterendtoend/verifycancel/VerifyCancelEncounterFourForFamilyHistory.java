...
public class VerifyCancelEncounterFourForFamilyHistory extends TestBaseClass{
	...
	@Test(retryAnalyzer = RetryRule.class, groups = { "Regression" }, description = "Test to verify cancel Encounter For Family History: 6")
	@Parameters({"userAccount","webSite","browser","seleniumHost","seleniumPort"})

	public void verifyCancelEncounterFourForFamilyHistory(String userAccount,String webSite,String browser, String seleniumHost, String seleniumPort) throws Exception 
	{		
		...
		verifyCancel(userAccount, familyHistoryData, webSite, browser, seleniumHost, seleniumPort);
	}	
		/**
	...
	private boolean verifyCancel(String userAccount,ChartPreVisitLib familyHistoryData, String webSite, String browser, String seleniumHost, String seleniumPort) throws Exception {
		try
		{
			//--------------------------------------------------------------------//
			...
			sharedPage=homePage.navigateToSharedPage();
			sharedPage.switchRole(driver, familyHistoryData3.switchRole);
			...
			//--------------------------------------------------------------------//
			//  Step-9:Edit Family History from Summary							 	  //
			//--------------------------------------------------------------------//		
			...
			homePage = loginPage.loginForNexiaFromProviderSite(driver,userAccount, familyHistoryData4.userName, familyHistoryData4.userPassword);
			logTitleMessage("Login successful");
			...
			//--------------------------------------------------------------------//
			//  Step-10:Edit the Family History again	from Pending Encounter						 	  //
			//--------------------------------------------------------------------//		
