...
public class VerifySaveEditandDeleteEncounterFiveWithSocialHistory extends TestBaseClass {
	...
	@Test(retryAnalyzer = RetryRule.class, groups = { "Regression" }, description = "Test for Verify Save Edit and Delete Encounter Five with social history")
	@Parameters({"userAccount","webSite","browser","seleniumHost","seleniumPort"})
	public void verifySaveEditandDeleteEncounterFiveWithSocialHistory(String userAccount,String website,String browser,String seleniumHost,String seleniumPort) throws Exception {
	 ...
	 verifySaveEditandDeleteEncounterFiveWithSocialHistory(socialHisData,userAccount);
}

	/**
     * VerifySaveEditandDeleteEncounterFive
     * To Verify function Save Edit and Delete Encounter Five with Social History
     * @param socialHisData(Social History details to be added )
     * @param userAccount(Application Environment)
     * @since  May 22, 2015
     */

	public boolean verifySaveEditandDeleteEncounterFiveWithSocialHistory(ChartPreVisitLib socialHisData, String userAccount) throws Exception{
		...
		try{			
			...
			//--------------------------------------------------------------------//
			//  Step-6: Social History A in summary page 					      //
			//--------------------------------------------------------------------//
			...
			logTitleMessage("Sucessfully Added Socail History A in summary page");
			...
			//--------------------------------------------------------------------//
			//  Step-16:Verify Social History C in Summary						  //
			//--------------------------------------------------------------------//		
