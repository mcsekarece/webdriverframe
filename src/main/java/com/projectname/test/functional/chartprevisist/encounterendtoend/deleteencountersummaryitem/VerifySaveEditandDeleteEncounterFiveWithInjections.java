...
public class VerifySaveEditandDeleteEncounterFiveWithInjections extends TestBaseClass {
	...
	@Test(retryAnalyzer = RetryRule.class, groups = { "Regression" }, description = "Test for Verify Save Edit and Delete Encounter Five with Injections")
	@Parameters({"userAccount","webSite","browser","seleniumHost","seleniumPort"})
	public void verifySaveEditandDeleteEncounterFiveWithInjections(String userAccount,String website,String browser,String seleniumHost,String seleniumPort) throws Exception {
	 ...
	 verifySaveEditandDeleteEncounterFiveWithInjections(injectionData,userAccount);
}

	/**
     * VerifySaveEditandDeleteEncounterFive
     * To Verify function Save Edit and Delete Encounter Five with Injections
     * @param injectionData(Injections details to be added )
     * @param userAccount(Application Environment)
     * @since  May 22, 2015
     */

	public boolean verifySaveEditandDeleteEncounterFiveWithInjections(ChartPreVisitLib injectionData, String userAccount) throws Exception{
		...
		try{			
			...
			//--------------------------------------------------------------------//
			//  Step-6: Injections A in summary page 					      //
			//--------------------------------------------------------------------//
			...
			//--------------------------------------------------------------------//
			//  Step-16:Verify Injections C in Summary						  //
			//--------------------------------------------------------------------//		
