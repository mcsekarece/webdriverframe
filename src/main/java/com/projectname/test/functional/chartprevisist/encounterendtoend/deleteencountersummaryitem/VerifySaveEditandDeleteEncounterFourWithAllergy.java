...
public class VerifySaveEditandDeleteEncounterFourWithAllergy extends TestBaseClass {
	...
	@Test(retryAnalyzer = RetryRule.class, groups = { "Regression" }, description = "Test for Verify Save Edit and Delete Encounter Four with Allergy")
	@Parameters({"userAccount","webSite","browser","seleniumHost","seleniumPort"})
	
	public void verifySaveEditandDeleteEncounterFourWithAllergy(String userAccount,String website,String browser,String seleniumHost,String seleniumPort) throws Exception {
	 ...
	 verifySaveEditandDeleteEncounterFourWithAllergy(allergyData,userAccount);
}

	/**
     * VerifySaveEditandDeleteEncounterFour
     * To Verify function Save Edit and Delete Encounter Four with Allergy
     * @param allergyData(Allergy details to be added )
     * @param userAccount(Application Environment)
     * @since  May 25, 2015
     */

	public boolean verifySaveEditandDeleteEncounterFourWithAllergy(ChartPreVisitLib allergyData, String userAccount) throws Exception{
		...
		try{			
			...
			//--------------------------------------------------------------------//
			//  Step-9: Edit Allergy from B --> C in Summary				      //
			//--------------------------------------------------------------------//		
