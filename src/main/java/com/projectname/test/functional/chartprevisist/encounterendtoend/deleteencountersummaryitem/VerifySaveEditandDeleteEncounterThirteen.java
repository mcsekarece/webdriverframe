...
public class VerifySaveEditandDeleteEncounterThirteen extends TestBaseClass {
	...
	@Test(retryAnalyzer = RetryRule.class, groups = { "Regression" }, description = "Test for Verify Save Edit and Delete Encounter Thirteen")
	@Parameters({"userAccount","webSite","browser","seleniumHost","seleniumPort"})
	public void verifySaveEditandDeleteEncounterThirteen(String userAccount,String website,String browser,String seleniumHost,String seleniumPort) throws Exception {
	...
	/**
     * VerifySaveEditandDeleteEncounterThirteen
     * To Verify function Save Edit and Delete Encounter Thirteen
	...
	public boolean verifySaveEditandDeleteEncounter(ChartPreVisitLib problemListData, String userAccount) throws Exception{
		...
		try{			
			...
			logTitleMessage("Add the Problem List in encounter page B");
			...
			logTitleMessage("Sucessfully Added the Problem List in encounter page B");
			
			//--------------------------------------------------------------------//
			//  Step-9: Delete the Problem List B and save the Encounter		 // 
			//--------------------------------------------------------------------//
