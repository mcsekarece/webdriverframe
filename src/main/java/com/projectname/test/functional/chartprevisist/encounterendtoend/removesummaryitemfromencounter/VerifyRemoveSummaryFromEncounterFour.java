...
public class VerifyRemoveSummaryFromEncounterFour extends TestBaseClass{
     ...
     * To Verify Remove Summary Item From Encounter - Four
	...
	public boolean VerifyRemoveSummaryFromEncounter(ChartPreVisitLib problemListData, String userAccount) throws Exception{
		...
		try{			
			...
			//--------------------------------------------------------------------//
			//  Step-10:  Edit the Problem List B -> c in summary page	     	      // 
			//--------------------------------------------------------------------//		
			...
			logTitleMessage("Navigate to Problem List b -> c  in summary page");
			patientChartPage.clickEditProblemList(problemListPage);
			logTitleMessage("Sucessfully navigated to Problem List in summary page");
			logTitleMessage("Edit the Problem List in summary page");
			...
			logTitleMessage("Sucessfully Edited the Problem List B -> C in summary page");
			...
			//--------------------------------------------------------------------//
			//  Step-12: Navigate to Edit Problem List C in encounter page	     // 
			//--------------------------------------------------------------------//		
			...
			patientChartPage.clickSaveEditProblemList(driver, problemListPage);
			logTitleMessage("Sucessfully Edited the Problem List C -> D in encounter page");
			
			//------------------------------------------------------------------------//
			//  Step-13:  Remove the Problem List D in encounter page 				  // 
			//-----------------------------------------------------------------------//		
