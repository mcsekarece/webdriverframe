...
public class VerifyRemoveSummaryFromEncounterThreeWithInjection extends TestBaseClass {
	...
	public void verifyRemoveSummaryFromEncounterThree(String userAccount,String website,String browser,String seleniumHost,String seleniumPort) throws Exception {
	...
	public boolean VerifyRemoveSummaryFromEncounter(ChartPreVisitLib injectionDataA, String userAccount) throws Exception{
		...
		try{
			...
			//--------------------------------------------------------------------//
			//  Step-9:   Navigate to saved Encounter 	  						  // 
			//--------------------------------------------------------------------//
			...
			//--------------------------------------------------------------------//
			//  Step-10:  Edit the Injection B in encounter page	     	      // 
			//--------------------------------------------------------------------//		
			...
			logTitleMessage("Successfully verified the Injection in Summary");
