...
public class Constants {
	...
	public static String userAccount = "US2000";
	public static String propUserAccountCA = "EH1480";
	public static final String CAACCOUNT="CA2000";
	public static final String USACCOUNT="US2000";
